...
public class ai
  implements Serializable, Cloneable, a<ai, a>
{
  ...
  static
  {
    ...
    localEnumMap.put(a.e, new org.apache.thrift.meta_data.b("request", (byte)2, new g((byte)12, ah.class)));
    ...
    localEnumMap.put(a.h, new org.apache.thrift.meta_data.b("category", (byte)2, new c((byte)11)));
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  bool1 = a();
                  bool2 = paramai.a();
                } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.a.equals(paramai.a))));
                bool1 = b();
                bool2 = paramai.b();
              } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.b.a(paramai.b))));
              bool1 = c();
              bool2 = paramai.c();
            } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.c.equals(paramai.c))));
            bool1 = d();
            bool2 = paramai.d();
          } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.d.equals(paramai.d))));
          bool1 = e();
          bool2 = paramai.e();
        } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.e.a(paramai.e)) || (this.f != paramai.f)));
        bool1 = g();
        bool2 = paramai.g();
      } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.g.equals(paramai.g))));
      bool1 = h();
      bool2 = paramai.h();
    } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.h.equals(paramai.h))));
    return true;
  }
  
  public int b(ai paramai)
  {
    int i1;
    if (!getClass().equals(paramai.getClass())) {
      i1 = getClass().getName().compareTo(paramai.getClass().getName());
    }
    int i2;
    do
    {
                            ...
                            do
                            {
                              do
                              {
                                do
                                {
                                  ...
                                  {
                                    return i1;
                                    i2 = Boolean.valueOf(a()).compareTo(Boolean.valueOf(paramai.a()));
                                    i1 = i2;
                                  } while (i2 != 0);
                                  if (!a()) {
                                    break;
                                  }
                                  i2 = org.apache.thrift.b.a(this.a, paramai.a);
                                  i1 = i2;
                                } while (i2 != 0);
                                i2 = Boolean.valueOf(b()).compareTo(Boolean.valueOf(paramai.b()));
                                i1 = i2;
                              } while (i2 != 0);
                              if (!b()) {
                                break;
                              }
                              i2 = org.apache.thrift.b.a(this.b, paramai.b);
                              i1 = i2;
                            } while (i2 != 0);
                            i2 = Boolean.valueOf(c()).compareTo(Boolean.valueOf(paramai.c()));
                            i1 = i2;
                          } while (i2 != 0);
                          if (!c()) {
                            break;
                          }
                          i2 = org.apache.thrift.b.a(this.c, paramai.c);
                          i1 = i2;
                        } while (i2 != 0);
                        i2 = Boolean.valueOf(d()).compareTo(Boolean.valueOf(paramai.d()));
                        i1 = i2;
                      } while (i2 != 0);
                      if (!d()) {
                        break;
                      }
                      i2 = org.apache.thrift.b.a(this.d, paramai.d);
                      i1 = i2;
                    } while (i2 != 0);
                    i2 = Boolean.valueOf(e()).compareTo(Boolean.valueOf(paramai.e()));
                    i1 = i2;
                  } while (i2 != 0);
                  if (!e()) {
                    break;
                  }
                  i2 = org.apache.thrift.b.a(this.e, paramai.e);
                  i1 = i2;
                } while (i2 != 0);
                i2 = Boolean.valueOf(f()).compareTo(Boolean.valueOf(paramai.f()));
                i1 = i2;
              } while (i2 != 0);
              if (!f()) {
                break;
              }
              i2 = org.apache.thrift.b.a(this.f, paramai.f);
              i1 = i2;
            } while (i2 != 0);
            i2 = Boolean.valueOf(g()).compareTo(Boolean.valueOf(paramai.g()));
            i1 = i2;
          } while (i2 != 0);
          if (!g()) {
            break;
          }
          i2 = org.apache.thrift.b.a(this.g, paramai.g);
          i1 = i2;
        } while (i2 != 0);
        i2 = Boolean.valueOf(h()).compareTo(Boolean.valueOf(paramai.h()));
        i1 = i2;
      } while (i2 != 0);
      if (!h()) {
        break;
      }
      i2 = org.apache.thrift.b.a(this.h, paramai.h);
      i1 = i2;
    } while (i2 != 0);
    return 0;
  }
  ...
  {
    if (paramObject == null) {}
    while (!(paramObject instanceof ai)) {
      return false;
    }
    return a((ai)paramObject);
  }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/xiaomi/xmpush/thrift/ai.class
