...
public class al
  implements Serializable, Cloneable, a<al, a>
{
  ...
  static
  {
    ...
    localEnumMap.put(a.e, new org.apache.thrift.meta_data.b("request", (byte)2, new g((byte)12, ak.class)));
                  ...
                  do
                  {
                    do
                    {
                      do
                      {
                        ...
                        bool1 = a();
                        bool2 = paramal.a();
                      } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.a.equals(paramal.a))));
                      bool1 = b();
                      bool2 = paramal.b();
                    } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.b.a(paramal.b))));
                    bool1 = c();
                    bool2 = paramal.c();
                  } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.c.equals(paramal.c))));
                  bool1 = d();
                  bool2 = paramal.d();
                } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.d.equals(paramal.d))));
                bool1 = e();
                bool2 = paramal.e();
              } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.e.a(paramal.e))));
              bool1 = f();
              bool2 = paramal.f();
            } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (this.f != paramal.f)));
            bool1 = g();
            bool2 = paramal.g();
          } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.g.equals(paramal.g))));
          bool1 = i();
          bool2 = paramal.i();
        } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.h.equals(paramal.h))));
        bool1 = j();
        bool2 = paramal.j();
      } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.i.equals(paramal.i))));
      bool1 = l();
      bool2 = paramal.l();
    } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.j.equals(paramal.j))));
    return true;
  }
  ...
  {
    int i1;
    if (!getClass().equals(paramal.getClass())) {
      i1 = getClass().getName().compareTo(paramal.getClass().getName());
    }
    int i2;
    do
    {
                                    ...
                                    do
                                    {
                                      do
                                      {
                                        do
                                        {
                                          ...
                                          {
                                            return i1;
                                            i2 = Boolean.valueOf(a()).compareTo(Boolean.valueOf(paramal.a()));
                                            i1 = i2;
                                          } while (i2 != 0);
                                          if (!a()) {
                                            break;
                                          }
                                          i2 = org.apache.thrift.b.a(this.a, paramal.a);
                                          i1 = i2;
                                        } while (i2 != 0);
                                        i2 = Boolean.valueOf(b()).compareTo(Boolean.valueOf(paramal.b()));
                                        i1 = i2;
                                      } while (i2 != 0);
                                      if (!b()) {
                                        break;
                                      }
                                      i2 = org.apache.thrift.b.a(this.b, paramal.b);
                                      i1 = i2;
                                    } while (i2 != 0);
                                    i2 = Boolean.valueOf(c()).compareTo(Boolean.valueOf(paramal.c()));
                                    i1 = i2;
                                  } while (i2 != 0);
                                  if (!c()) {
                                    break;
                                  }
                                  i2 = org.apache.thrift.b.a(this.c, paramal.c);
                                  i1 = i2;
                                } while (i2 != 0);
                                i2 = Boolean.valueOf(d()).compareTo(Boolean.valueOf(paramal.d()));
                                i1 = i2;
                              } while (i2 != 0);
                              if (!d()) {
                                break;
                              }
                              i2 = org.apache.thrift.b.a(this.d, paramal.d);
                              i1 = i2;
                            } while (i2 != 0);
                            i2 = Boolean.valueOf(e()).compareTo(Boolean.valueOf(paramal.e()));
                            i1 = i2;
                          } while (i2 != 0);
                          if (!e()) {
                            break;
                          }
                          i2 = org.apache.thrift.b.a(this.e, paramal.e);
                          i1 = i2;
                        } while (i2 != 0);
                        i2 = Boolean.valueOf(f()).compareTo(Boolean.valueOf(paramal.f()));
                        i1 = i2;
                      } while (i2 != 0);
                      if (!f()) {
                        break;
                      }
                      i2 = org.apache.thrift.b.a(this.f, paramal.f);
                      i1 = i2;
                    } while (i2 != 0);
                    i2 = Boolean.valueOf(g()).compareTo(Boolean.valueOf(paramal.g()));
                    i1 = i2;
                  } while (i2 != 0);
                  if (!g()) {
                    break;
                  }
                  i2 = org.apache.thrift.b.a(this.g, paramal.g);
                  i1 = i2;
                } while (i2 != 0);
                i2 = Boolean.valueOf(i()).compareTo(Boolean.valueOf(paramal.i()));
                i1 = i2;
              } while (i2 != 0);
              if (!i()) {
                break;
              }
              i2 = org.apache.thrift.b.a(this.h, paramal.h);
              i1 = i2;
            } while (i2 != 0);
            i2 = Boolean.valueOf(j()).compareTo(Boolean.valueOf(paramal.j()));
            i1 = i2;
          } while (i2 != 0);
          if (!j()) {
            break;
          }
          i2 = org.apache.thrift.b.a(this.i, paramal.i);
          i1 = i2;
        } while (i2 != 0);
        i2 = Boolean.valueOf(l()).compareTo(Boolean.valueOf(paramal.l()));
        i1 = i2;
      } while (i2 != 0);
      if (!l()) {
        break;
      }
      i2 = org.apache.thrift.b.a(this.j, paramal.j);
      i1 = i2;
    } while (i2 != 0);
    return 0;
  }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/xiaomi/xmpush/thrift/al.class
