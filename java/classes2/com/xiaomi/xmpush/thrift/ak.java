...
public class ak
  implements Serializable, Cloneable, a<ak, a>
{
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  bool1 = a();
                  bool2 = paramak.a();
                } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.a.equals(paramak.a))));
                bool1 = b();
                bool2 = paramak.b();
              } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.b.a(paramak.b))));
              bool1 = c();
              bool2 = paramak.c();
            } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.c.equals(paramak.c))));
            bool1 = d();
            bool2 = paramak.d();
          } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.d.equals(paramak.d))));
          bool1 = e();
          bool2 = paramak.e();
        } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.e.equals(paramak.e))));
        bool1 = f();
        bool2 = paramak.f();
      } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.f.equals(paramak.f))));
      bool1 = g();
      bool2 = paramak.g();
    } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.g.equals(paramak.g))));
    return true;
  }
  ...
  {
    int i1;
    if (!getClass().equals(paramak.getClass())) {
      i1 = getClass().getName().compareTo(paramak.getClass().getName());
    }
    int i2;
    do
    {
                        ...
                        do
                        {
                          do
                          {
                            do
                            {
                              ...
                              {
                                return i1;
                                i2 = Boolean.valueOf(a()).compareTo(Boolean.valueOf(paramak.a()));
                                i1 = i2;
                              } while (i2 != 0);
                              if (!a()) {
                                break;
                              }
                              i2 = org.apache.thrift.b.a(this.a, paramak.a);
                              i1 = i2;
                            } while (i2 != 0);
                            i2 = Boolean.valueOf(b()).compareTo(Boolean.valueOf(paramak.b()));
                            i1 = i2;
                          } while (i2 != 0);
                          if (!b()) {
                            break;
                          }
                          i2 = org.apache.thrift.b.a(this.b, paramak.b);
                          i1 = i2;
                        } while (i2 != 0);
                        i2 = Boolean.valueOf(c()).compareTo(Boolean.valueOf(paramak.c()));
                        i1 = i2;
                      } while (i2 != 0);
                      if (!c()) {
                        break;
                      }
                      i2 = org.apache.thrift.b.a(this.c, paramak.c);
                      i1 = i2;
                    } while (i2 != 0);
                    i2 = Boolean.valueOf(d()).compareTo(Boolean.valueOf(paramak.d()));
                    i1 = i2;
                  } while (i2 != 0);
                  if (!d()) {
                    break;
                  }
                  i2 = org.apache.thrift.b.a(this.d, paramak.d);
                  i1 = i2;
                } while (i2 != 0);
                i2 = Boolean.valueOf(e()).compareTo(Boolean.valueOf(paramak.e()));
                i1 = i2;
              } while (i2 != 0);
              if (!e()) {
                break;
              }
              i2 = org.apache.thrift.b.a(this.e, paramak.e);
              i1 = i2;
            } while (i2 != 0);
            i2 = Boolean.valueOf(f()).compareTo(Boolean.valueOf(paramak.f()));
            i1 = i2;
          } while (i2 != 0);
          if (!f()) {
            break;
          }
          i2 = org.apache.thrift.b.a(this.f, paramak.f);
          i1 = i2;
        } while (i2 != 0);
        i2 = Boolean.valueOf(g()).compareTo(Boolean.valueOf(paramak.g()));
        i1 = i2;
      } while (i2 != 0);
      if (!g()) {
        break;
      }
      i2 = org.apache.thrift.b.a(this.g, paramak.g);
      i1 = i2;
    } while (i2 != 0);
    return 0;
  }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/xiaomi/xmpush/thrift/ak.class
