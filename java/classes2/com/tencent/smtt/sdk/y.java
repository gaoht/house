  ...
  extends android.webkit.WebViewClient
{
  ...
  y(WebView paramWebView, WebViewClient paramWebViewClient)
  {
    this.b = paramWebView;
  ...
  public void onReceivedError(android.webkit.WebView paramWebView, android.webkit.WebResourceRequest paramWebResourceRequest, WebResourceError paramWebResourceError)
  {
    ...
    for (paramWebView = new f(paramWebResourceRequest);; paramWebView = null)
    {
      ...
      if (paramWebResourceError != null) {
        paramWebResourceRequest = new aa(this, paramWebResourceError);
      }
  ...
  public android.webkit.WebResourceResponse shouldInterceptRequest(android.webkit.WebView paramWebView, android.webkit.WebResourceRequest paramWebResourceRequest)
  {
    ...
    do
    {
      do
      {
        ...
        paramWebView = new e(paramWebResourceRequest.getUrl().toString(), paramWebResourceRequest.isForMainFrame(), paramWebResourceRequest.hasGesture(), paramWebResourceRequest.getMethod(), paramWebResourceRequest.getRequestHeaders());
  ...
  public boolean shouldOverrideUrlLoading(android.webkit.WebView paramWebView, String paramString)
  {
    ...
    do
    {
      return true;
      this.b.a(paramWebView);
    } while (r.a().a(this.b.getContext().getApplicationContext(), paramString));
    ...
    implements com.tencent.smtt.export.external.interfaces.WebResourceRequest
  {
    ...
    public e(boolean paramBoolean1, boolean paramBoolean2, String paramString, Map<String, String> paramMap)
    {
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/tencent/smtt/sdk/y.class
