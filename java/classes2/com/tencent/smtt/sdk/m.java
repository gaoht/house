  ...
  extends X5ProxyWebChromeClient
{
  ...
  public m(IX5WebChromeClient paramIX5WebChromeClient, WebView paramWebView, WebChromeClient paramWebChromeClient)
  {
  ...
  public boolean onCreateWindow(IX5WebViewBase paramIX5WebViewBase, boolean paramBoolean1, boolean paramBoolean2, Message paramMessage)
  {
    ...
    paramMessage = Message.obtain(paramMessage.getTarget(), new n(this, paramIX5WebViewBase, paramMessage));
  ...
  {
    paramValueCallback = new p(this, paramValueCallback);
    paramFileChooserParams = new q(this, paramFileChooserParams);
    this.a.a(paramIX5WebViewBase);
  ...
  {
    this.b.openFileChooser(new o(this, paramValueCallback), paramString1, paramString2);
  }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/tencent/smtt/sdk/m.class
