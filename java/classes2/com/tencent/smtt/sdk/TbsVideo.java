...
public class TbsVideo
{
  ...
  {
    return at.a(paramContext).a();
  }
  
  public static boolean canUseYunbo(Context paramContext)
  {
    return (at.a(paramContext).a()) && (QbSdk.canUseVideoFeatrue(paramContext, 1));
  }
  ...
  public static boolean openYunboVideo(Context paramContext, String paramString, Bundle paramBundle, a parama)
  {
    if (canUseYunbo(paramContext)) {
      return at.a(paramContext).a(paramString, paramBundle, parama);
    }
    return false;
  }
}
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/tencent/smtt/sdk/TbsVideo.class
