  ...
  implements MediaPlayer.OnErrorListener
{
  ...
  void a()
  {
    ...
    if (this.b == null)
    {
      k.a(true).a(getContext().getApplicationContext(), false, false, null);
      aw localaw = k.a(true).a();
      if (localaw != null) {
        localDexLoader = localaw.b();
      }
      if ((localDexLoader != null) && (QbSdk.canLoadVideo(getContext()))) {
        this.b = new ax(localDexLoader);
      }
    }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/tencent/smtt/sdk/av.class
