    ...
    public static Uri[] parseResult(int paramInt, Intent paramIntent)
    {
      try
      {
        ...
        if ((localbg != null) && (localbg.c())) {
          return localbg.d().a(paramInt, paramIntent);
        }
        paramIntent = u.a(Class.forName("com.android.webview.chromium.FileChooserParamsAdapter"), "parseFileChooserResult", new Class[] { Integer.TYPE, Intent.class }, new Object[] { Integer.valueOf(paramInt), paramIntent });
        if (paramIntent == null) {
          return null;
        }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/tencent/smtt/sdk/WebChromeClient.class
