...
public class WebViewClient
{
  ...
  public void onReceivedError(WebView paramWebView, WebResourceRequest paramWebResourceRequest, WebResourceError paramWebResourceError)
  {
    if ((this.a != null) && (paramWebResourceRequest.isForMainFrame())) {
      this.a.onReceivedError(paramWebView.b(), paramWebResourceError.getErrorCode(), paramWebResourceError.getDescription().toString(), paramWebResourceRequest.getUrl().toString());
    }
  }
  ...
  {
    if (this.a != null) {
      return this.a.shouldInterceptRequest(paramWebView.b(), paramWebResourceRequest.getUrl().toString());
    }
    return null;
  }
  ...
  {
    if (this.a != null) {
      return this.a.shouldInterceptRequest(paramWebView.b(), paramWebResourceRequest);
    }
    return null;
  }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/tencent/smtt/sdk/WebViewClient.class
