...
public final class c
{
  ...
  private c(int paramInt, int[] paramArrayOfInt, b... paramVarArgs)
  {
    ...
    while (paramInt < m)
    {
      ...
      i += (paramVarArgs.getDataCodewords() + k) * j;
      paramInt += 1;
    }
    this.f = i;
  }
  ...
  private static c[] a()
  {
    ...
    localObject37 = new c(37, new int[] { 6, 28, 54, 80, 106, 132, 158 }, new b[] { localObject37, localObject38, localObject39, localb1 });
    ...
    localObject38 = new c(38, new int[] { 6, 32, 58, 84, 110, 136, 162 }, new b[] { localObject38, localObject39, localb1, localb2 });
    ...
    localObject39 = new c(39, new int[] { 6, 26, 54, 82, 110, 138, 166 }, new b[] { localObject39, localb1, localb2, localb3 });
    ...
    throws g
  {
    ...
    try
    {
      c localc = getVersionForNumber(paramInt - 17 >> 2);
      return localc;
    }
  ...
  public static c getVersionForNumber(int paramInt)
  {
  ...
  public b getECBlocksForLevel(a parama)
  {
    return this.e[parama.ordinal()];
  }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/google/c/d/a/c.class
