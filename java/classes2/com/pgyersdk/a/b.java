  ...
  extends f
{
  ...
  protected HashMap a(Void... paramVarArgs)
  {
    for (;;)
    {
      try
      {
        ...
        this.a = new e("http://www.pgyer.com/apiv1/sdkstat/install").a("POST").a(localHashMap, this.c, null, null).a();
        this.a.connect();
  ...
  protected void a(HashMap paramHashMap)
  {
    ...
    try
    {
      if ("0".equals(new JSONObject(paramHashMap).getString("code")))
      {
        i.a(a.a(), "install", "1");
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/pgyersdk/a/b.class
