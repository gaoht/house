...
public class b
{
  ...
  public static String a(h paramh, int paramInt)
  {
    String str = null;
    if (paramh != null) {
      str = paramh.getStringForResource(paramInt);
    }
    paramh = str;
    if (str == null) {
      paramh = (String)a.get(Integer.valueOf(paramInt));
    }
    return paramh;
  }
}
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/pgyersdk/b/b.class
