...
public class a
{
    ...
    throws IOException
  {
    ...
    //   5: aload_0
    //   6: ifnonnull +13 -> 19
    //   9: new 168	java/lang/NullPointerException
    //   12: dup
    //   13: ldc -34
    //   15: invokespecial 173	java/lang/NullPointerException:<init>	(Ljava/lang/String;)V
    //   18: athrow
    //   19: aload_0
    //   20: ldc -32
    //   22: invokevirtual 227	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   25: astore_2
    //   26: aload_2
    //   27: astore_0
    //   28: aload_0
    //   29: aload_0
    //   30: arraylength
    //   31: invokestatic 229	com/unionpay/mobile/android/utils/a:a	([BI)[B
    //   34: astore 6
    //   36: aload 6
    //   38: ifnull +118 -> 156
    //   41: aload 6
    ...
    //   82: dup
    //   83: invokespecial 234	java/io/ByteArrayOutputStream:<init>	()V
    //   86: astore 4
    //   88: new 236	java/io/ByteArrayInputStream
    //   91: dup
    //   92: aload 6
    //   94: invokespecial 239	java/io/ByteArrayInputStream:<init>	([B)V
    //   97: astore_2
    //   98: new 241	java/util/zip/GZIPInputStream
    //   101: dup
    //   102: aload_2
    //   103: invokespecial 244	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   106: astore_0
    //   107: aload_0
    //   108: aload 7
    //   110: invokevirtual 248	java/util/zip/GZIPInputStream:read	([B)I
    //   113: istore_1
    //   114: iload_1
    //   115: iflt +53 -> 168
    //   118: aload 4
    ...
    //   122: iconst_0
    //   123: iload_1
    //   124: invokevirtual 252	java/io/ByteArrayOutputStream:write	([BII)V
    //   127: goto -20 -> 107
    //   130: astore 5
    //   132: aload_0
    //   133: astore_3
    ...
    //   143: aload 4
    //   145: invokevirtual 258	java/io/ByteArrayOutputStream:close	()V
    //   148: aload_3
    //   149: invokevirtual 259	java/util/zip/GZIPInputStream:close	()V
    //   152: aload_0
    //   153: invokevirtual 260	java/io/ByteArrayInputStream:close	()V
    //   156: aload 6
    //   158: areturn
    //   159: astore_2
    //   160: aload_0
    //   161: invokevirtual 263	java/lang/String:getBytes	()[B
    //   164: astore_0
    //   165: goto -137 -> 28
    //   168: aload 4
    //   170: invokevirtual 266	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   173: astore_3
    //   174: aload 4
    //   176: invokevirtual 258	java/io/ByteArrayOutputStream:close	()V
    //   179: aload_0
    //   180: invokevirtual 259	java/util/zip/GZIPInputStream:close	()V
    //   183: aload_2
    //   184: invokevirtual 260	java/io/ByteArrayInputStream:close	()V
    //   187: aload_3
    //   188: areturn
    //   189: astore_0
    //   190: aload_3
    ...
    //   200: astore_3
    //   201: aload 4
    //   203: invokevirtual 258	java/io/ByteArrayOutputStream:close	()V
    //   206: aload_3
    //   207: invokevirtual 259	java/util/zip/GZIPInputStream:close	()V
    //   210: aload_2
    //   211: invokevirtual 260	java/io/ByteArrayInputStream:close	()V
    //   214: aload_0
    //   215: athrow
    //   216: astore 4
    //   218: goto -39 -> 179
    ...
    //   159	25	2	localUnsupportedEncodingException	java.io.UnsupportedEncodingException
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/unionpay/mobile/android/utils/a.class
