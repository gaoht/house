...
public class RoutePlanningMapActivity
  extends BaseActivity
{
  ...
  private void a()
  {
    ...
    this.t.setText(((TransitRouteLine)this.g.get(0)).getTerminal().getTitle());
    this.v.setOnTouchListener(new View.OnTouchListener()
    {
      public boolean onTouch(View paramAnonymousView, MotionEvent paramAnonymousMotionEvent)
      {
        return RoutePlanningMapActivity.a(RoutePlanningMapActivity.this).dispatchTouchEvent(paramAnonymousMotionEvent);
      }
    });
    this.a.setOnPageChangeListener(new ViewPager.OnPageChangeListener()
    {
      ...
      {
        if (RoutePlanningMapActivity.a(RoutePlanningMapActivity.this) != null) {
          RoutePlanningMapActivity.a(RoutePlanningMapActivity.this).invalidate();
        }
      }
      
      public void onPageSelected(int paramAnonymousInt)
      {
        RoutePlanningMapActivity.a(RoutePlanningMapActivity.this, paramAnonymousInt);
      }
    });
  }
    ...
    extends FragmentPagerAdapter
  {
    ...
    public int getCount()
    {
      return RoutePlanningMapActivity.b(RoutePlanningMapActivity.this).size();
    }
    
    public Fragment getItem(int paramInt)
    {
      return (Fragment)RoutePlanningMapActivity.b(RoutePlanningMapActivity.this).get(paramInt);
    }
  }
}


/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/ziroom/ziroomcustomer/findhouse/RoutePlanningMapActivity.class
