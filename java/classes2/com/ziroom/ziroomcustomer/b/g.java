...
public class g
{
  private static StringBuffer a()
  {
    ...
    localStringBuffer.append("CREATE TABLE IF NOT EXISTS t_houstlistBizcircle(");
  ...
  public static int getBizCount(Context paramContext)
  {
    paramContext = new e(paramContext);
    com.freelxl.baselibrary.c.b localb = paramContext.getSession();
    Cursor localCursor = localb.rawQuery("SELECT * FROM t_houstlistBizcircle WHERE cityCode=?", new String[] { com.ziroom.ziroomcustomer.base.b.d });
  ...
  {
    paramb = paramb.rawQuery("SELECT * FROM t_houstlistBizcircle WHERE name =? AND cityCode =?", new String[] { paramString, com.ziroom.ziroomcustomer.base.b.d });
    return (paramb != null) && (paramb.moveToNext());
  }
  
  public static ArrayList<HouselistSuggestBean> queryBizcircle(Context paramContext, int paramInt)
  {
    int i = 0;
    paramContext = new e(paramContext);
    com.freelxl.baselibrary.c.b localb = paramContext.getSession();
    ArrayList localArrayList = new ArrayList();
    Cursor localCursor = localb.rawQuery("SELECT * FROM t_houstlistBizcircle WHERE cityCode=? ORDER BY count DESC", new String[] { com.ziroom.ziroomcustomer.base.b.d });
    if (localCursor != null) {
      while ((localCursor.moveToNext()) && (i < paramInt))
      {
        ...
        localHouselistSuggestBean.setType(1);
  ...
  public static boolean sava(Context paramContext, String paramString1, String paramString2)
  {
    ...
    if (isExist(localb, paramString2))
    {
      ...
      paramString1.append("update ").append("t_houstlistBizcircle").append(" set count = count+1,lastTime=").append(System.currentTimeMillis()).append(" where name = '").append(paramString2).append("' and cityCode = '").append(com.ziroom.ziroomcustomer.base.b.d).append("'");
    ...
    for (;;)
    {
      ...
      localb.insert("t_houstlistBizcircle", null, localContentValues);
    }
  }
}


/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/ziroom/ziroomcustomer/b/g.class
