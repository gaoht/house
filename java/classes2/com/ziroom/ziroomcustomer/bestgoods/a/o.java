  ...
  extends BaseAdapter
{
  ...
  public o(Context paramContext, z paramz, List<ab> paramList)
  {
    this.a = paramContext;
    this.b = paramList;
    this.c = paramz;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramView = LayoutInflater.from(this.a).inflate(2130904575, null);
      paramViewGroup.a = ((SimpleDraweeView)paramView.findViewById(2131695803));
      paramViewGroup.b = ((TextView)paramView.findViewById(2131690720));
      paramViewGroup.c = ((TextView)paramView.findViewById(2131695561));
      paramViewGroup.d = ((Button)paramView.findViewById(2131695804));
    ...
    for (;;)
    {
      paramViewGroup.d.setOnClickListener(new View.OnClickListener()
      {
        ...
        public void onClick(View paramAnonymousView)
        {
          ...
          paramAnonymousView = o.a(o.this).getStyleCode();
          Intent localIntent = new Intent(o.b(o.this), BestGoodsListAc.class);
          localIntent.putExtra("styleCode", paramAnonymousView);
          localIntent.putExtra("styleName", o.a(o.this).getStyleName());
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/ziroom/ziroomcustomer/bestgoods/a/o.class
