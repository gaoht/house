  ...
  extends BaseAdapter
{
  ...
  public v(Context paramContext, List<al> paramList)
  {
    this.a = paramContext;
    this.b = paramList;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = View.inflate(this.a, 2130904405, null);
    ...
    for (;;)
    {
      ...
      paramViewGroup.d.setTextColor(-3026479);
      ...
      paramViewGroup.d.setText(localal.getEndDate() + "有效");
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/ziroom/ziroomcustomer/bestgoods/a/v.class
