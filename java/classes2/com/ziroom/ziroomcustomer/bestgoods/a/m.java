  ...
  extends BaseAdapter
{
  ...
  public m(Context paramContext, z paramz, List<ab> paramList)
  {
    this.a = paramContext;
    this.b = paramList;
    this.c = paramz;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramView = LayoutInflater.from(this.a).inflate(2130904448, null);
      paramViewGroup.a = ((SimpleDraweeView)paramView.findViewById(2131695559));
      paramViewGroup.b = ((TextView)paramView.findViewById(2131690720));
      paramViewGroup.c = ((TextView)paramView.findViewById(2131695561));
      paramViewGroup.d = ((Button)paramView.findViewById(2131695560));
    ...
    for (;;)
    {
      paramViewGroup.d.setOnClickListener(new View.OnClickListener()
      {
        ...
        public void onClick(View paramAnonymousView)
        {
          ...
          paramAnonymousView = m.a(m.this).getStyleCode();
          Intent localIntent = new Intent(m.b(m.this), BestGoodsListAc.class);
          localIntent.putExtra("styleCode", paramAnonymousView);
          localIntent.putExtra("styleName", m.a(m.this).getStyleName());
          m.b(m.this).startActivity(localIntent);
        }
      });
      return paramView;
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/ziroom/ziroomcustomer/bestgoods/a/m.class
