  ...
  implements ViewPager.OnPageChangeListener
{
  ...
  private ImageView a(String paramString)
  {
    if (this.u == 0)
    {
      ...
      ((SimpleDraweeView)localObject).setLayoutParams(new LinearLayout.LayoutParams(this.a, this.a));
      c.frescoHierarchyController((SimpleDraweeView)localObject, this.w, 2131624042);
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/ziroom/ziroomcustomer/bestgoods/widget/CycleViewPager.class
