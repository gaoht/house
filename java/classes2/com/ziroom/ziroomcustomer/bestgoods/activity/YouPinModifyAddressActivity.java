...
public class YouPinModifyAddressActivity
  ...
  implements View.OnClickListener, OnGetSuggestionResultListener
{
      ...
      if (localObject1 != null)
      {
        ((c)localObject1).addListener(new com.d.a.b()
        {
          public void onAnimationEnd(com.d.a.a paramAnonymousa)
          {
            ...
            if (!paramBoolean) {
              YouPinModifyAddressActivity.q(YouPinModifyAddressActivity.this).setVisibility(8);
            }
          }
          ...
          public void onAnimationStart(com.d.a.a paramAnonymousa)
          {
            ...
            if (paramBoolean)
            {
              YouPinModifyAddressActivity.q(YouPinModifyAddressActivity.this).setVisibility(0);
              YouPinModifyAddressActivity.e(YouPinModifyAddressActivity.this).requestFocus();
              YouPinModifyAddressActivity.e(YouPinModifyAddressActivity.this).setSelection(VdsAgent.trackEditTextSilent(YouPinModifyAddressActivity.e(YouPinModifyAddressActivity.this)).toString().length());
              ((InputMethodManager)YouPinModifyAddressActivity.c(YouPinModifyAddressActivity.this).getSystemService("input_method")).toggleSoftInput(0, 2);
            }
          }
        });
  ...
  private void e()
  {
    ...
    this.B.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener()
    {
      ...
      {
        int i = YouPinModifyAddressActivity.a(YouPinModifyAddressActivity.this).getWidth();
        ViewGroup.LayoutParams localLayoutParams = YouPinModifyAddressActivity.a(YouPinModifyAddressActivity.this).getLayoutParams();
        localLayoutParams.height = (i / 2);
        YouPinModifyAddressActivity.a(YouPinModifyAddressActivity.this).setLayoutParams(localLayoutParams);
      }
    });
    ...
    this.G.setOnItemClickListener(new AdapterView.OnItemClickListener()
    {
      ...
      public void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
      {
        ...
        if (((LatPoint)YouPinModifyAddressActivity.b(YouPinModifyAddressActivity.this).get(paramAnonymousInt)).getLatlng() == null)
        {
          g.textToast(YouPinModifyAddressActivity.c(YouPinModifyAddressActivity.this), "该地址无效，请重新输入地址");
          return;
        }
        YouPinModifyAddressActivity.a(YouPinModifyAddressActivity.this, ((LatPoint)YouPinModifyAddressActivity.b(YouPinModifyAddressActivity.this).get(paramAnonymousInt)).getLatlng());
        YouPinModifyAddressActivity.d(YouPinModifyAddressActivity.this).setText(((LatPoint)YouPinModifyAddressActivity.b(YouPinModifyAddressActivity.this).get(paramAnonymousInt)).getAddress() + ((LatPoint)YouPinModifyAddressActivity.b(YouPinModifyAddressActivity.this).get(paramAnonymousInt)).getName());
        YouPinModifyAddressActivity.e(YouPinModifyAddressActivity.this).setText(((LatPoint)YouPinModifyAddressActivity.b(YouPinModifyAddressActivity.this).get(paramAnonymousInt)).getName());
        YouPinModifyAddressActivity.e(YouPinModifyAddressActivity.this).clearFocus();
        ((InputMethodManager)YouPinModifyAddressActivity.c(YouPinModifyAddressActivity.this).getSystemService("input_method")).hideSoftInputFromWindow(YouPinModifyAddressActivity.e(YouPinModifyAddressActivity.this).getWindowToken(), 0);
        YouPinModifyAddressActivity.a(YouPinModifyAddressActivity.this, 1);
        YouPinModifyAddressActivity.a(YouPinModifyAddressActivity.this, YouPinModifyAddressActivity.f(YouPinModifyAddressActivity.this), YouPinModifyAddressActivity.g(YouPinModifyAddressActivity.this), YouPinModifyAddressActivity.h(YouPinModifyAddressActivity.this));
        YouPinModifyAddressActivity.a(YouPinModifyAddressActivity.this, new com.ziroom.ziroomcustomer.newmovehouse.b.a(new ArrayList(), YouPinModifyAddressActivity.c(YouPinModifyAddressActivity.this)));
        YouPinModifyAddressActivity.j(YouPinModifyAddressActivity.this).setAdapter(YouPinModifyAddressActivity.i(YouPinModifyAddressActivity.this));
        YouPinModifyAddressActivity.i(YouPinModifyAddressActivity.this).notifyDataSetChanged();
        YouPinModifyAddressActivity.a(YouPinModifyAddressActivity.this, false);
      }
    });
  ...
  private void f()
  {
    ...
    for (;;)
    {
      ...
      com.ziroom.ziroomcustomer.e.j.modifYouPinAddressList(this.x, localHashMap, new d());
      return;
      localHashMap.put("fid", "");
    }
    com.ziroom.ziroomcustomer.e.j.modifYouPinAddressList(this.x, localHashMap, new a());
  }
    ...
    implements i.a<String>
  {
    ...
    public void onSuccess(k paramk)
    {
      if (paramk.getSuccess().booleanValue())
      {
        ...
        YouPinModifyAddressActivity.this.setResult(-1, localIntent);
        YouPinModifyAddressActivity.this.finish();
      }
      for (;;)
      {
        YouPinModifyAddressActivity.p(YouPinModifyAddressActivity.this).setClickable(true);
        YouPinModifyAddressActivity.this.dismissProgress();
        return;
        paramk = paramk.getMessage();
        if (paramk != null) {
          g.textToast(YouPinModifyAddressActivity.c(YouPinModifyAddressActivity.this), paramk);
        } else {
          g.textToast(YouPinModifyAddressActivity.c(YouPinModifyAddressActivity.this), "修改地址失败，请重试");
        }
      }
    }
  }
    ...
    extends com.ziroom.ziroomcustomer.newServiceList.view.a
  {
    ...
    public void onTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
    {
      ...
      {
        YouPinModifyAddressActivity.a(YouPinModifyAddressActivity.this, "");
        YouPinModifyAddressActivity.k(YouPinModifyAddressActivity.this).clear();
        YouPinModifyAddressActivity.l(YouPinModifyAddressActivity.this);
        return;
      }
      if (paramCharSequence.length() > 0) {
        w.onEvent(YouPinModifyAddressActivity.c(YouPinModifyAddressActivity.this), "dailyaddaddress_community");
      }
      YouPinModifyAddressActivity.m(YouPinModifyAddressActivity.this).requestSuggestion(new SuggestionSearchOption().keyword(paramCharSequence.toString()).city(YouPinModifyAddressActivity.this.a));
    }
  }
    ...
    implements LabeledEditText.a
  {
    ...
    public void afterTextChanged(Editable paramEditable)
    {
      ...
      {
        YouPinModifyAddressActivity.b(YouPinModifyAddressActivity.this, 1);
        YouPinModifyAddressActivity.a(YouPinModifyAddressActivity.this, YouPinModifyAddressActivity.f(YouPinModifyAddressActivity.this), YouPinModifyAddressActivity.g(YouPinModifyAddressActivity.this), YouPinModifyAddressActivity.h(YouPinModifyAddressActivity.this));
        YouPinModifyAddressActivity.o(YouPinModifyAddressActivity.this).setVisibility(0);
        return;
      }
      YouPinModifyAddressActivity.b(YouPinModifyAddressActivity.this, 0);
      YouPinModifyAddressActivity.p(YouPinModifyAddressActivity.this).setTextColor(-6710887);
      YouPinModifyAddressActivity.o(YouPinModifyAddressActivity.this).setVisibility(8);
    }
    ...
    public void onTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
    {
      ...
      {
        g.textToast(YouPinModifyAddressActivity.c(YouPinModifyAddressActivity.this), "字数超出限制！");
        YouPinModifyAddressActivity.n(YouPinModifyAddressActivity.this).setText(paramCharSequence.subSequence(0, 64).toString());
        YouPinModifyAddressActivity.n(YouPinModifyAddressActivity.this).setSelection(YouPinModifyAddressActivity.n(YouPinModifyAddressActivity.this).getText().length());
      }
    }
  }
    ...
    implements i.a<String>
  {
    ...
    public void onSuccess(k paramk)
    {
      if (paramk.getSuccess().booleanValue())
      {
        paramk = new Intent(YouPinModifyAddressActivity.c(YouPinModifyAddressActivity.this), CleanAddressActivity.class);
        YouPinModifyAddressActivity.this.setResult(-1, paramk);
        YouPinModifyAddressActivity.this.finish();
      }
      for (;;)
      {
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/ziroom/ziroomcustomer/bestgoods/activity/YouPinModifyAddressActivity.class
