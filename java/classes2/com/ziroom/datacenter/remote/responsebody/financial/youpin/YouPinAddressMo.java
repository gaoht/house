...
public class YouPinAddressMo
  implements Parcelable
{
  public static final Parcelable.Creator<YouPinAddressMo> CREATOR = new Parcelable.Creator()
  {
    public YouPinAddressMo createFromParcel(Parcel paramAnonymousParcel)
    {
      return new YouPinAddressMo(paramAnonymousParcel);
    }
    
    public YouPinAddressMo[] newArray(int paramAnonymousInt)
    {
      return new YouPinAddressMo[paramAnonymousInt];
    }
  };
  private String a;
  private String b;
  ...
  protected YouPinAddressMo(Parcel paramParcel)
  {
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/ziroom/datacenter/remote/responsebody/financial/youpin/YouPinAddressMo.class
