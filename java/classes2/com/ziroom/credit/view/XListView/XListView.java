  ...
  implements AbsListView.OnScrollListener
{
  ...
  private void a(Context paramContext)
  {
    ...
    this.f = ((RelativeLayout)this.e.findViewById(R.id.credit_xlistview_header_content));
    this.g = ((TextView)this.e.findViewById(R.id.credit_xlistview_header_time));
    ...
    this.e.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener()
    {
      ...
      {
        XListView.a(XListView.this, XListView.a(XListView.this).getHeight());
...
/* Location:              /Users/gaoht/Downloads/zirom/classes2-dex2jar.jar!/com/ziroom/credit/view/XListView/XListView.class
