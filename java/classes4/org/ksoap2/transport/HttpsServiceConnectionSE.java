  ...
  implements ServiceConnection
{
    ...
    throws IOException
  {
    if (paramProxy == null)
    {
      paramProxy = new URL("https", paramString1, paramInt1, paramString2);
      if (!(paramProxy instanceof URL))
      {
        paramProxy = paramProxy.openConnection();
        this.connection = ((HttpsURLConnection)paramProxy);
        label42:
        paramProxy = new URL("https", paramString1, paramInt1, paramString2);
        if ((paramProxy instanceof URL)) {
          break label121;
    ...
    label121:
    for (paramProxy = paramProxy.openConnection();; paramProxy = HttpInstrumentation.openConnection((URL)paramProxy))
    {
      this.connection = ((HttpsURLConnection)paramProxy);
      ...
      break;
      this.connection = ((HttpsURLConnection)new URL("https", paramString1, paramInt1, paramString2).openConnection(paramProxy));
      break label42;
    }
  }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes4-dex2jar.jar!/org/ksoap2/transport/HttpsServiceConnectionSE.class
