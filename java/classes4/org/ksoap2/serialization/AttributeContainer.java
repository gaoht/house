  ...
  implements HasAttributes
{
  ...
  protected boolean attributesAreEqual(AttributeContainer paramAttributeContainer)
  {
    ...
    while (i < j)
    {
      ...
      if (!paramAttributeContainer.hasAttribute(localAttributeInfo.getName())) {
        return false;
      }
      if (!localObject.equals(paramAttributeContainer.getAttributeSafely(localAttributeInfo.getName()))) {
        return false;
      }
      i += 1;
    }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes4-dex2jar.jar!/org/ksoap2/serialization/AttributeContainer.class
