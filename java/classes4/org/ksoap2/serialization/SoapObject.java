  ...
  implements KvmSerializable
{
  ...
  public Object getPrimitiveProperty(String paramString)
  {
    ...
    if (localObject1 != null)
    {
      ...
      while ((localObject2 != localObject1) && (localPropertyInfo.getValue() != null))
      {
  ...
  public String getPrimitivePropertyAsString(String paramString)
  {
    ...
    if (localObject1 != null)
    {
      ...
      while ((localObject2 != paramString) && (((PropertyInfo)localObject1).getValue() != null))
      {
  ...
  public String getPrimitivePropertySafelyAsString(String paramString)
  {
    ...
    if (paramString != null)
    {
      ...
      while ((localObject != paramString) && (localPropertyInfo.getValue() != null))
      {
        return localPropertyInfo.getValue().toString();
        paramString = class$org$ksoap2$serialization$SoapObject;
      }
  ...
  public boolean isPropertyEqual(Object paramObject, int paramInt)
  {
    ...
    do
    {
      ...
      if (((paramObject instanceof PropertyInfo)) && ((localObject instanceof PropertyInfo)))
      {
        ...
        localObject = (PropertyInfo)localObject;
        if ((((PropertyInfo)paramObject).getName().equals(((PropertyInfo)localObject).getName())) && (((PropertyInfo)paramObject).getValue().equals(((PropertyInfo)localObject).getValue()))) {}
  ...
  public SoapObject newInstance()
  {
    ...
    while (j < getAttributeCount())
    {
      localObject = new AttributeInfo();
      getAttributeInfo(j, (AttributeInfo)localObject);
...
/* Location:              /Users/gaoht/Downloads/zirom/classes4-dex2jar.jar!/org/ksoap2/serialization/SoapObject.class
