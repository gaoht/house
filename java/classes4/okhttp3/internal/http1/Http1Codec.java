  ...
  implements HttpCodec
{
  ...
  {
    u localu = parami.delegate();
    parami.setDelegate(u.NONE);
    ...
    throws IOException
  {
    ...
    if (!HttpHeaders.hasBody(paramResponse)) {
      return new RealResponseBody(str, 0L, l.buffer(newFixedLengthSource(0L)));
    }
    if ("chunked".equalsIgnoreCase(paramResponse.header("Transfer-Encoding"))) {
      return new RealResponseBody(str, -1L, l.buffer(newChunkedSource(paramResponse.request().url())));
    }
    long l = HttpHeaders.contentLength(paramResponse);
    if (l != -1L) {
      return new RealResponseBody(str, l, l.buffer(newFixedLengthSource(l)));
    }
    return new RealResponseBody(str, -1L, l.buffer(newUnknownLengthSource()));
  }
    ...
    implements s
  {
      ...
      throws IOException
    {
      ...
      //   23: getfield 28	okhttp3/internal/http1/Http1Codec:sink	Ld/d;
      //   26: ldc 46
      ...
      //   38: aload_0
      //   39: getfield 38	okhttp3/internal/http1/Http1Codec$ChunkedSink:timeout	Ld/i;
      //   42: invokevirtual 54	okhttp3/internal/http1/Http1Codec:detachTimeout	(Ld/i;)V
      //   45: aload_0
      ...
      throws IOException
    {
      ...
      //   18: getfield 28	okhttp3/internal/http1/Http1Codec:sink	Ld/d;
...
/* Location:              /Users/gaoht/Downloads/zirom/classes4-dex2jar.jar!/okhttp3/internal/http1/Http1Codec.class
