...
final class Relay
{
    ...
    throws IOException
  {
    ...
    paramt = new Relay(paramFile, paramt, 0L, paramf, paramLong);
    paramFile.setLength(0L);
    paramt.writeHeader(PREFIX_DIRTY, -1L, -1L);
    return paramt;
  }
    ...
    throws IOException
  {
    ...
    if (!localc.readByteString(PREFIX_CLEAN.size()).equals(PREFIX_CLEAN)) {
    ...
    throws IOException
  {
    c localc = new c();
    localc.write(paramf);
    localc.writeLong(paramLong1);
    localc.writeLong(paramLong2);
    if (localc.size() != 32L) {
    ...
    implements t
  {
      ...
      throws IOException
    {
      ...
      //   73: ifnull +23 -> 96
      //   76: aload_0
      //   77: getfield 29	okhttp3/internal/cache2/Relay$RelaySource:timeout	Ld/u;
      //   80: aload_0
      //   81: getfield 21	okhttp3/internal/cache2/Relay$RelaySource:this$0	Lokhttp3/internal/cache2/Relay;
      //   84: invokevirtual 89	d/u:waitUntilNotified	(Ljava/lang/Object;)V
      //   87: goto -61 -> 26
      //   90: astore_1
      //   91: aload 9
      //   93: monitorexit
      ...
      //   142: aload_1
      //   143: lload_2
      //   144: invokevirtual 106	okhttp3/internal/cache2/FileOperator:read	(JLd/c;J)V
      //   147: aload_0
      //   148: aload_0
      ...
      //   165: getfield 110	okhttp3/internal/cache2/Relay:buffer	Ld/c;
      //   168: invokevirtual 116	d/c:size	()J
      //   171: lsub
      //   172: lstore 7
      //   174: aload_0
      ...
      //   209: getfield 110	okhttp3/internal/cache2/Relay:buffer	Ld/c;
      //   212: aload_1
      //   213: aload_0
      ...
      //   219: lsub
      //   220: lload_2
      //   221: invokevirtual 120	d/c:copyTo	(Ld/c;JJ)Ld/c;
      //   224: pop
      //   225: aload_0
      //   226: aload_0
      ...
      //   244: getfield 124	okhttp3/internal/cache2/Relay:upstream	Ld/t;
      //   247: aload_0
      //   248: getfield 21	okhttp3/internal/cache2/Relay$RelaySource:this$0	Lokhttp3/internal/cache2/Relay;
      //   251: getfield 127	okhttp3/internal/cache2/Relay:upstreamBuffer	Ld/c;
      //   254: aload_0
      ...
      //   332: getfield 127	okhttp3/internal/cache2/Relay:upstreamBuffer	Ld/c;
      //   335: aload_1
      //   336: lconst_0
      //   337: lload_2
      //   338: invokevirtual 120	d/c:copyTo	(Ld/c;JJ)Ld/c;
      //   341: pop
      //   342: aload_0
      //   343: aload_0
      ...
      //   366: getfield 127	okhttp3/internal/cache2/Relay:upstreamBuffer	Ld/c;
      //   369: invokevirtual 143	d/c:clone	()Ld/c;
      //   372: lload 7
      //   374: invokevirtual 146	okhttp3/internal/cache2/FileOperator:write	(JLd/c;J)V
      //   377: aload_0
      ...
      //   388: getfield 110	okhttp3/internal/cache2/Relay:buffer	Ld/c;
      //   391: aload_0
      //   392: getfield 21	okhttp3/internal/cache2/Relay$RelaySource:this$0	Lokhttp3/internal/cache2/Relay;
      //   395: getfield 127	okhttp3/internal/cache2/Relay:upstreamBuffer	Ld/c;
      //   398: lload 7
      //   400: invokevirtual 149	d/c:write	(Ld/c;J)V
      //   403: aload_0
      //   404: getfield 21	okhttp3/internal/cache2/Relay$RelaySource:this$0	Lokhttp3/internal/cache2/Relay;
      //   407: getfield 110	okhttp3/internal/cache2/Relay:buffer	Ld/c;
      //   410: invokevirtual 116	d/c:size	()J
      //   413: aload_0
      ...
      //   428: getfield 110	okhttp3/internal/cache2/Relay:buffer	Ld/c;
      //   431: aload_0
      //   432: getfield 21	okhttp3/internal/cache2/Relay$RelaySource:this$0	Lokhttp3/internal/cache2/Relay;
      //   435: getfield 110	okhttp3/internal/cache2/Relay:buffer	Ld/c;
      //   438: invokevirtual 116	d/c:size	()J
      //   441: aload_0
      ...
      //   448: lsub
      //   449: invokevirtual 152	d/c:skip	(J)V
      //   452: aload_0
...
/* Location:              /Users/gaoht/Downloads/zirom/classes4-dex2jar.jar!/okhttp3/internal/cache2/Relay.class
