    ...
    throws IOException
  {
    ...
    paramCacheRequest = new t()
    {
        ...
        throws IOException
      {
        ...
        paramAnonymousc.copyTo(this.val$cacheBody.buffer(), paramAnonymousc.size() - paramAnonymousLong, paramAnonymousLong);
    ...
    return paramResponse.newBuilder().body(new RealResponseBody((String)localObject, l, l.buffer(paramCacheRequest))).build();
  }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes4-dex2jar.jar!/okhttp3/internal/cache/CacheInterceptor.class
