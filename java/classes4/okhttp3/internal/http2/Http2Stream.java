...
public final class Http2Stream
{
    ...
    implements s
  {
      ...
      throws IOException
    {
      ...
      //   112: aload_0
      //   113: getfield 43	okhttp3/internal/http2/Http2Stream$FramingSink:sendBuffer	Ld/c;
      //   116: invokevirtual 80	d/c:size	()J
      ...
      //   175: lload_3
      //   176: aload_0
      //   177: getfield 43	okhttp3/internal/http2/Http2Stream$FramingSink:sendBuffer	Ld/c;
      //   180: invokevirtual 80	d/c:size	()J
      //   183: lcmp
      //   184: ifne +28 -> 212
      //   187: iconst_1
      //   188: istore_1
      ...
      //   192: iload_1
      //   193: aload_0
      //   194: getfield 43	okhttp3/internal/http2/Http2Stream$FramingSink:sendBuffer	Ld/c;
      //   197: lload_3
      //   198: invokevirtual 100	okhttp3/internal/http2/Http2Connection:writeData	(IZLd/c;J)V
      //   201: aload_0
    ...
    implements t
  {
      ...
      throws IOException
    {
      ...
      //   10: aload_0
      //   11: getfield 44	okhttp3/internal/http2/Http2Stream$FramingSource:readBuffer	Ld/c;
      //   14: invokevirtual 80	d/c:size	()J
      //   17: lconst_0
      //   18: lcmp
      //   19: ifne +50 -> 69
      //   22: aload_0
      //   23: getfield 82	okhttp3/internal/http2/Http2Stream$FramingSource:finished	Z
      //   26: ifne +43 -> 69
      //   29: aload_0
      ...
      //   50: invokevirtual 85	okhttp3/internal/http2/Http2Stream:waitForIo	()V
      //   53: goto -43 -> 10
      //   56: astore_1
      //   57: aload_0
      ...
      //   64: invokevirtual 88	okhttp3/internal/http2/Http2Stream$StreamTimeout:exitAndThrowIfTimedOut	()V
      //   67: aload_1
      //   68: athrow
      //   69: aload_0
      ...
      //   76: invokevirtual 88	okhttp3/internal/http2/Http2Stream$StreamTimeout:exitAndThrowIfTimedOut	()V
      //   79: return
      // Local variable table:
      //   start	length	slot	name	signature
...
/* Location:              /Users/gaoht/Downloads/zirom/classes4-dex2jar.jar!/okhttp3/internal/http2/Http2Stream.class
