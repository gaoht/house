...
public class MyTravelListAdapter$MyTravelViewHolder_ViewBinding<T extends MyTravelListAdapter.MyTravelViewHolder>
  implements Unbinder
{
  protected T a;
  
  public MyTravelListAdapter$MyTravelViewHolder_ViewBinding(T paramT, View paramView)
  {
    this.a = paramT;
  ...
  public void unbind()
  {
    MyTravelListAdapter.MyTravelViewHolder localMyTravelViewHolder = this.a;
...
/* Location:              /Users/gaoht/Downloads/zirom/classes3-dex2jar.jar!/com/ziroom/ziroomcustomer/my/adapter/MyTravelListAdapter$MyTravelViewHolder_ViewBinding.class
