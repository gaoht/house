...
public class SharedLifeGestureLockActivity
  extends BaseActivity
{
  ...
  Runnable b = new Runnable()
  {
    public void run()
    {
      if (SharedLifeGestureLockActivity.this.gestureLockViewGroup.b) {
        SharedLifeGestureLockActivity.this.gestureLockViewGroup.resetView();
      }
    }
  };
  ...
  private SharedLifeGestureLockActivity r;
  @BindView(2131690682)
  View rl_container;
  private List<a.a> s;
  @BindView(2131690684)
      ...
      j.getGestureLock(this, str, new com.ziroom.commonlibrary.a.a.b(this, new com.ziroom.commonlibrary.a.b.b())
      {
        public void onSuccess(int paramAnonymousInt, com.alibaba.fastjson.e paramAnonymouse)
        {
          ...
          if (paramAnonymouse != null)
          {
            ...
            SharedLifeGestureLockActivity.this.gestureLockViewGroup.savePassword(paramAnonymouse);
            SharedLifeGestureLockActivity.this.gestureLockViewGroup.loadPasswordStatus();
            SharedLifeGestureLockActivity.a(SharedLifeGestureLockActivity.this, 2);
            SharedLifeGestureLockActivity.this.tv_errorView.setText("");
          }
          for (;;)
          {
            SharedLifeGestureLockActivity.this.initTitle();
            SharedLifeGestureLockActivity.this.a();
            SharedLifeGestureLockActivity.this.rl_container.setVisibility(0);
            return;
            label100:
            SharedLifeGestureLockActivity.a(SharedLifeGestureLockActivity.this, 1);
            SharedLifeGestureLockActivity.this.tv_errorView.setText("为了您的门锁安全，请先设置手势密码");
          }
        }
      });
    }
  ...
  private void h()
  {
    if ((this.s != null) && (this.s.size() > 0))
    {
      if (this.s.size() == 1)
      {
        localIntent = new Intent(this.r, SharedLifeEquipmentHomeActivity.class);
        localIntent.putExtra("rentContractCode", ((a.a)this.s.get(0)).getRentContractCode());
        localIntent.putExtra("villageName", ((a.a)this.s.get(0)).getVillage());
        startActivity(localIntent);
        finish();
        return;
      }
      localIntent = new Intent(this.r, SharedLifeContractActivity.class);
      localIntent.putExtra("tbRentContracts", com.alibaba.fastjson.a.toJSONString(this.s));
      startActivity(localIntent);
      finish();
      return;
    }
    Intent localIntent = new Intent(this.r, SharedLifeContractActivity.class);
    localIntent.putExtra("tbRentContracts", "");
    startActivity(localIntent);
    finish();
  }
    ...
    if (!TextUtils.isEmpty(str)) {
      j.setGestureLock(this, str, this.gestureLockViewGroup.getPassword(), new com.ziroom.commonlibrary.a.a.b(this, new com.ziroom.commonlibrary.a.b.b())
      {
        public void onFailure(Throwable paramAnonymousThrowable)
        {
          ...
          g.textToast(SharedLifeGestureLockActivity.this, paramAnonymousThrowable);
          SharedLifeGestureLockActivity.a(SharedLifeGestureLockActivity.this, 1);
          SharedLifeGestureLockActivity.this.initTitle();
          SharedLifeGestureLockActivity.this.a();
          SharedLifeGestureLockActivity.this.gestureLockPathView.resetPath();
          SharedLifeGestureLockActivity.this.gestureLockViewGroup.removePassword();
        }
        
        public void onSuccess(int paramAnonymousInt, com.alibaba.fastjson.e paramAnonymouse)
        {
          super.onSuccess(paramAnonymousInt, paramAnonymouse);
          if (SharedLifeGestureLockActivity.a(SharedLifeGestureLockActivity.this) != null) {
            try
            {
              paramAnonymouse = Toast.makeText(SharedLifeGestureLockActivity.this, "手势密码创建成功!", 0);
              if (!(paramAnonymouse instanceof Toast)) {
                paramAnonymouse.show();
              }
              for (;;)
              {
                SharedLifeGestureLockActivity.this.tv_errorView.setText("手势密码创建成功!");
                paramAnonymouse = new Intent(SharedLifeGestureLockActivity.this, Class.forName(SharedLifeGestureLockActivity.a(SharedLifeGestureLockActivity.this)));
                SharedLifeGestureLockActivity.this.startActivity(paramAnonymouse);
                SharedLifeGestureLockActivity.this.finish();
                return;
  ...
  private void j()
  {
    this.gestureLockViewGroup.setGesturePasswordSettingListener(new com.ziroom.ziroomcustomer.gesturelock.view.a.b()
    {
      public void onFail()
      {
        SharedLifeGestureLockActivity.this.tv_errorView.setText("与首次输入不一致，请重新输入");
      }
      ...
      public boolean onFirstInputComplete(int paramAnonymousInt)
      {
        ...
        {
          SharedLifeGestureLockActivity.this.tv_errorView.setText("首次记录成功，请再次输入密码");
          return true;
        }
        SharedLifeGestureLockActivity.this.tv_errorView.setText("最少连接5个点，请重新输入");
        return false;
      }
      
      public void onSuccess()
      {
        SharedLifeGestureLockActivity.b(SharedLifeGestureLockActivity.this);
      }
    });
  }
  ...
  private void k()
  {
    this.gestureLockViewGroup.setGestureEventListener(new com.ziroom.ziroomcustomer.gesturelock.view.a.a()
    {
      public void onGestureEvent(boolean paramAnonymousBoolean)
      {
        ...
        {
          SharedLifeGestureLockActivity.this.tv_errorView.setTextColor(Color.parseColor("#F03E3E"));
          SharedLifeGestureLockActivity.this.tv_errorView.setText("密码输入错误，请重新输入");
          SharedLifeGestureLockActivity.this.a.removeCallbacks(SharedLifeGestureLockActivity.this.b);
          SharedLifeGestureLockActivity.this.a.postDelayed(SharedLifeGestureLockActivity.this.b, 2000L);
          return;
        }
        if (SharedLifeGestureLockActivity.c(SharedLifeGestureLockActivity.this))
        {
          SharedLifeGestureLockActivity.a(SharedLifeGestureLockActivity.this, false);
          SharedLifeGestureLockActivity.this.tv_errorView.setText("");
          SharedLifeGestureLockActivity.d(SharedLifeGestureLockActivity.this);
          return;
        }
        SharedLifeGestureLockActivity.this.tv_errorView.setTextColor(Color.parseColor("#FFA000"));
        SharedLifeGestureLockActivity.this.tv_errorView.setText("手势密码正确!");
        SharedLifeGestureLockActivity.b(SharedLifeGestureLockActivity.this);
      }
    });
  }
    ...
    this.gestureLockViewGroup.setCurrentPathListener(new com.ziroom.ziroomcustomer.gesturelock.view.a.c()
    {
      ...
      public void drawCurrentPath(String paramAnonymousString)
      {
        if (!TextUtils.isEmpty(paramAnonymousString))
        {
          ...
          SharedLifeGestureLockActivity.this.gestureLockPathView.setCurrentPath(arrayOfInt);
        }
      }
    });
  }
  ...
  public void initTitle()
  {
    ...
    if (!TextUtils.isEmpty(str)) {
      this.s = com.alibaba.fastjson.a.parseArray(str, a.a.class);
    }
    if (this.f == 1) {
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131690687: 
      this.gestureLockPathView.resetPath();
      this.tv_forgotten.setText("忘记手势密码？");
      paramView = new Intent(this, SharedLifeVerifyActivity.class);
      paramView.putExtra("sl_contractList", getIntent().getStringExtra("sl_contractList"));
...
/* Location:              /Users/gaoht/Downloads/zirom/classes3-dex2jar.jar!/com/ziroom/ziroomcustomer/sharedlife/activity/SharedLifeGestureLockActivity.class
