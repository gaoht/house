  ...
  extends k
{
  ...
  public h(int paramInt, List<MHServiceTime.DataBean.MoveOrderTimeBean> paramList, Context paramContext)
  {
    a(paramInt);
    this.c = paramList;
    this.d = paramContext;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (((MHServiceTime.DataBean.MoveOrderTimeBean)this.c.get(paramInt)).getHaveCapacity() == 1)
    {
      ...
      if (this.b == paramInt)
      {
        ...
        paramView.f.setTextColor(40960);
        if (!TextUtils.isEmpty(((MHServiceTime.DataBean.MoveOrderTimeBean)this.c.get(paramInt)).getRemark())) {
          break label293;
        }
    ...
    for (;;)
    {
      ...
      paramView.f.setTextColor(-6710887);
      break;
      label293:
      paramView.f.setVisibility(0);
      paramView.f.setText(((MHServiceTime.DataBean.MoveOrderTimeBean)this.c.get(paramInt)).getRemark());
      continue;
      paramView.f.setVisibility(0);
      paramView.f.setText(((MHServiceTime.DataBean.MoveOrderTimeBean)this.c.get(paramInt)).getRemark());
...
/* Location:              /Users/gaoht/Downloads/zirom/classes3-dex2jar.jar!/com/ziroom/ziroomcustomer/newmovehouse/b/h.class
