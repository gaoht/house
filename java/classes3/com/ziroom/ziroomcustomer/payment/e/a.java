...
public class a
{
  ...
  private Handler f = new Handler()
  {
    public void handleMessage(Message paramAnonymousMessage)
    {
      ...
      b.setErrorLog(a.a(a.this), "获取RA配置信息失败", paramAnonymousMessage.getMessage(), new i(a.a(a.this), new e(Object.class)));
      a.a(a.this).dismissProgress();
    }
  };
  ...
  public a(BaseActivity paramBaseActivity, HashMap<String, String> paramHashMap, b paramb)
  {
    ...
    this.e = paramb;
    this.d = paramHashMap;
    d.getRaConfig(this.c, this.f);
    this.c.showProgress("", 100000L);
  }
  ...
  private void a()
  {
    if (!d())
    {
      this.c.showToast("无纸化签约证书出现问题,请稍后再试!!!");
      b.setErrorLog(this.c, "无纸化错误", ApplicationEx.c.k.GetLastErrInfo(), new i(this.c, new e(Object.class)));
    }
    do
    {
      return;
      this.a = new com.ziroom.ziroomcustomer.c.a(ApplicationEx.c.getRaConfig().getWebsite(), ApplicationEx.c.getRaConfig().getAccounthash(), this.c);
    } while (ApplicationEx.c.k != null);
    ApplicationEx.c.k = ClientForAndroid.getInstance(this.c);
  }
    ...
    new Thread(new Runnable()
    {
      public void run()
      {
        ...
        if (TextUtils.isEmpty(str))
        {
          ...
          b.setErrorLog(a.a(a.this), "生成CSR失败", "操作失败!!" + ApplicationEx.c.k.GetLastErrInfo(), new i(a.a(a.this), new e(Object.class)));
          a.a(a.this).dismissProgress();
    ...
    for (;;)
    {
      ...
      else
      {
        try
        {
          ...
          if ((ApplicationEx.c.getUser().getUid().equals(localObject3)) && (((String)this.d.get("name")).equals(localObject4)) && (a(Integer.parseInt((String)this.d.get("mCerType2"))).equals(localObject2)) && (((String)this.d.get("cerNum")).equals(str)))
          {
        ...
        catch (Exception localException)
        {
          ...
          b.setErrorLog(this.c, localException.getMessage(), ((StringBuffer)localObject2).toString(), new i(this.c, new e(Object.class)));
        }
      }
    }
  }
  ...
  private boolean d()
  {
    ...
    if (i == 0)
    {
      ApplicationEx.c.k.SetSystemDBDir(this.c.getApplicationContext().getFilesDir().getAbsolutePath() + "/db/");
      File localFile = new File(this.c.getApplicationContext().getFilesDir().getAbsolutePath() + "/db/");
      if (!localFile.exists()) {
        localFile.mkdirs();
      }
      return e();
  ...
  private boolean e()
  {
    ...
    if (i == 1)
    {
      ...
      b.setErrorLog(this.c, "初始化pin失败", "操作失败!!" + ApplicationEx.c.k.GetLastErrInfo(), new i(this.c, new e(Object.class)));
      this.c.dismissProgress();
      this.c.showToast("无纸化出现异常,请稍后再试!");
      return false;
    }
    if (i == 0) {}
    for (;;)
  ...
  private boolean f()
  {
    ...
    while (i < j)
    {
      ...
      localObject = new File(this.c.getApplicationContext().getFilesDir().getAbsolutePath() + "/" + (String)localObject);
  ...
  private boolean g()
  {
    ...
    {
      Object localObject = arrayOfString[i];
      localObject = new File(this.c.getApplicationContext().getFilesDir().getAbsolutePath() + "/db/" + (String)localObject);
      if (((File)localObject).exists()) {
        bool = ((File)localObject).delete();
      }
      i += 1;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!TextUtils.isEmpty(ApplicationEx.c.getUser().getUid()))
        {
          ...
          if ((ApplicationEx.c.getUser().getUid().equals(str4)) && (((String)this.d.get("name")).equals(localObject)) && (a(Integer.parseInt((String)this.d.get("mCerType2"))).equals(str3)) && (((String)this.d.get("cerNum")).equals(str2)))
          {
            u.d("ikey", "相同证书");
          }
          else
    ...
    extends AsyncTask<Bundle, Integer, String>
  {
    ...
    protected void a(String paramString)
    {
      ...
      {
        u.d("ikey", "证书申请失败");
        b.setErrorLog(a.a(a.this), "证书申请失败", "操作失败!!" + paramString, new i(a.a(a.this), new e(Object.class)));
      }
      for (;;)
      {
        a.a(a.this).dismissProgress();
        ...
        if ("$OKOKOK$".equals(paramString.substring(0, "$OKOKOK$".length())))
        {
          ...
          {
            b.setErrorLog(a.a(a.this), "证书导入失败!!!", "证书导入失败!!!" + ApplicationEx.c.k.GetLastErrInfo(), new i(a.a(a.this), new e(Object.class)));
          }
        }
        else
        {
          u.d("ikey", "证书申请失败!!!\n" + paramString);
          b.setErrorLog(a.a(a.this), "证书申请失败!!!", "证书申请失败!!!\n" + paramString + "\n" + ApplicationEx.c.k.GetLastErrInfo(), new i(a.a(a.this), new e(Object.class)));
          a.a(a.this).showToast("无纸化签约证书出现问题,请稍后再试!!!");
        }
      }
    }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes3-dex2jar.jar!/com/ziroom/ziroomcustomer/payment/e/a.class
