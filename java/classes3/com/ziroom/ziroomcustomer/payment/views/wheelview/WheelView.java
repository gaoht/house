  ...
  extends View
{
  ...
  private List<c> y = new LinkedList();
  ...
  private int getMaxTextLength()
  {
    ...
    int i1 = locald.getMaximumLength();
    if (i1 > 0) {
      return i1;
    }
    i1 = this.j / 2;
    ...
    Object localObject2;
    for (Object localObject1 = null; i1 < Math.min(this.g + this.j, locald.getItemsCount()); localObject1 = localObject2)
    {
      String str = locald.getItem(i1);
  ...
  protected void a()
  {
    ...
    while (localIterator.hasNext()) {
      ((c)localIterator.next()).onScrollingStarted(this);
    }
  }
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    ...
    while (localIterator.hasNext()) {
      ((b)localIterator.next()).onChanged(this, paramInt1, paramInt2);
    }
  }
  
  public void addChangingListener(b paramb)
  {
    this.x.add(paramb);
  }
  
  public void addScrollingListener(c paramc)
  {
    this.y.add(paramc);
  }
  ...
  protected void b()
  {
    Iterator localIterator = this.y.iterator();
    while (localIterator.hasNext()) {
      ((c)localIterator.next()).onScrollingFinished(this);
    }
  }
  ...
  public void removeChangingListener(b paramb)
  {
    this.x.remove(paramb);
  }
  
  public void removeScrollingListener(c paramc)
  {
...
/* Location:              /Users/gaoht/Downloads/zirom/classes3-dex2jar.jar!/com/ziroom/ziroomcustomer/payment/views/wheelview/WheelView.class
