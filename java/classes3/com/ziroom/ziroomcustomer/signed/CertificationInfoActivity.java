...
public class CertificationInfoActivity
  extends BaseActivity
{
  ...
  private f<e> r = new f(this.b, new o())
  {
    ...
    {
      CertificationInfoActivity.a(CertificationInfoActivity.this, (CertInfoEntity)h.parseObject(paramAnonymouse.toJSONString(), CertInfoEntity.class));
      if (CertificationInfoActivity.a(CertificationInfoActivity.this) != null) {
        CertificationInfoActivity.b(CertificationInfoActivity.this);
      }
    }
  };
    ...
    try
    {
        ...
        for (;;)
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if ((localObject2 != null) && ((((CertInfoEntity.NewsignCertListBean.CompanyBean)localObject2).getCompany_type() + "").equals(this.c.getCompany_type())))
            {
              ...
              {
                localObject1 = new Intent(this.b, CertInformationActivity.class);
      ...
      do
      {
        ...
        if (ae.notNull(this.c.credits.realRejectReason))
        {
          ...
          this.certification_why.setTextColor(Color.parseColor("#FF6262"));
        }
        for (;;)
        {
  ...
  public void onClic(View paramView)
  {
    ...
    default: 
      return;
    case 2131690128: 
      paramView = new Intent(this, CertInformationActivity.class);
...
/* Location:              /Users/gaoht/Downloads/zirom/classes3-dex2jar.jar!/com/ziroom/ziroomcustomer/signed/CertificationInfoActivity.class
