  ...
  extends BaseAdapter
{
  ...
  public o(Context paramContext, List<bf> paramList)
  {
    this.a = paramContext;
    this.b = paramList;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup.a.setController(c.frescoController(((bf)this.b.get(paramInt)).getPicUrl()));
      paramViewGroup.b.setText(((bf)this.b.get(paramInt)).getServiceInfoName());
      str = ((bf)this.b.get(paramInt)).getPriceRemark();
    ...
    for (;;)
    {
      paramViewGroup.d.setText(((bf)this.b.get(paramInt)).getSlogan());
      return paramView;
...
/* Location:              /Users/gaoht/Downloads/zirom/classes3-dex2jar.jar!/com/ziroom/ziroomcustomer/newServiceList/a/o.class
