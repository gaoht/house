...
public class b
{
  ...
  public static boolean checkBusinessId(String paramString)
  {
    return Pattern.compile("^[0-9A-Za-z]{1,30}$").matcher(paramString).matches();
  }
  
  public static boolean checkId(String paramString)
  {
    boolean bool = false;
    if (Pattern.compile("^[A-Za-z0-9]{1,20}$").matcher(paramString).matches()) {}
    for (int i = 1;; i = 0)
    {
  ...
  {
    return (Pattern.compile("^[A-Za-z0-9]{1,20}$").matcher(paramString).matches()) && (paramString.length() == 8);
  }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes3-dex2jar.jar!/com/ziroom/ziroomcustomer/minsu/f/b.class
