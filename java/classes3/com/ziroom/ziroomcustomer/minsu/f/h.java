...
public class h
{
  ...
  public static Bitmap getBlurBitmap(Bitmap paramBitmap, View paramView)
  {
    Bitmap localBitmap = Bitmap.createBitmap((int)(paramView.getMeasuredWidth() / 16.0F), (int)(paramView.getMeasuredHeight() / 16.0F), Bitmap.Config.ARGB_8888);
    Canvas localCanvas = new Canvas(localBitmap);
    localCanvas.translate(-paramView.getLeft() / 16.0F, -paramView.getTop() / 16.0F);
    localCanvas.scale(1.0F / 16.0F, 1.0F / 16.0F);
    paramView = new Paint();
    paramView.setFlags(2);
    localCanvas.drawBitmap(paramBitmap, 0.0F, 0.0F, paramView);
    return doBlur(localBitmap, (int)16.0F, true);
  }
  ...
  public static void setTempBitmap(Bitmap paramBitmap)
  {
    a = paramBitmap;
  }
}
...
/* Location:              /Users/gaoht/Downloads/zirom/classes3-dex2jar.jar!/com/ziroom/ziroomcustomer/minsu/f/h.class
