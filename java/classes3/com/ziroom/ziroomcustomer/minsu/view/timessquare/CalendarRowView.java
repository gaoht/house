  ...
  implements View.OnClickListener
{
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    while (paramInt1 < i)
    {
      getChildAt(paramInt1).layout(paramInt3 / 7 * (paramInt1 + 0), 0, paramInt3 / 7 * (paramInt1 + 1), paramInt4 - paramInt2);
      paramInt1 += 1;
    }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes3-dex2jar.jar!/com/ziroom/ziroomcustomer/minsu/view/timessquare/CalendarRowView.class
