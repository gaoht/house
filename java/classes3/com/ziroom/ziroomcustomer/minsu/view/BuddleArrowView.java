  ...
  extends ImageView
{
  ...
  public BuddleArrowView(Context paramContext)
  {
    super(paramContext);
    a(null);
  }
  
  public BuddleArrowView(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    a(paramAttributeSet);
  }
  
  public BuddleArrowView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  private void a(AttributeSet paramAttributeSet)
  {
    ...
    {
      paramAttributeSet = getContext().obtainStyledAttributes(paramAttributeSet, R.styleable.BubbleArrowImageView);
  ...
  {
    u.d("BuddleArrowView====", "=======    width= " + paramRectF.width() + " height= " + paramRectF.height());
    u.d("BuddleArrowView====", "=======    left= " + paramRectF.left + " top= " + paramRectF.top + "   right=" + paramRectF.right + "  boottom=" + paramRectF.bottom);
    u.d("BuddleArrowView====", "=======    mAngle= " + this.c + " mArrowWidth= " + this.e + "   mArrowTop=" + this.d + "  mArrowOffset=" + this.g);
    paramPath.moveTo(this.c, paramRectF.top);
    paramPath.lineTo(paramRectF.width(), paramRectF.top);
    paramPath.lineTo(paramRectF.width() - this.e, this.f);
    paramPath.lineTo(paramRectF.width() - this.e, paramRectF.bottom);
...
/* Location:              /Users/gaoht/Downloads/zirom/classes3-dex2jar.jar!/com/ziroom/ziroomcustomer/minsu/view/BuddleArrowView.class
