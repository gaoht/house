...
public class f
  extends k
{
  private List<WeekCapacityBean> c;
  private Context d;
  
  public f(int paramInt, List<WeekCapacityBean> paramList, Context paramContext)
  {
    a(paramInt);
    this.c = paramList;
    this.d = paramContext;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ("0".equals(((WeekCapacityBean)this.c.get(paramInt)).getFlag()))
    {
    ...
    for (;;)
    {
      paramView.e.setText(((WeekCapacityBean)this.c.get(paramInt)).getTimePoint());
      return localView;
  ...
  public void setData(List<WeekCapacityBean> paramList)
  {
    this.c = paramList;
...
/* Location:              /Users/gaoht/Downloads/zirom/classes3-dex2jar.jar!/com/ziroom/ziroomcustomer/newclean/periodclean/a/f.class
