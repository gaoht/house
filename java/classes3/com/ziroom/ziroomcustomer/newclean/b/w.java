  ...
  extends BaseAdapter
{
  ...
  public w(Context paramContext, List<av> paramList)
  {
    this.a = paramContext;
    this.b = paramList;
  }
    ...
    paramSpannableString.setSpan(new ClickableSpan()
    {
      ...
      public void onClick(View paramAnonymousView)
      {
        ...
        if (!TextUtils.isEmpty(paramString)) {
          ah.callPhone(w.a(w.this), paramString);
        }
        w.a(w.this, paramAnonymousView);
      }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes3-dex2jar.jar!/com/ziroom/ziroomcustomer/newclean/b/w.class
