  ...
  extends BaseAdapter
{
  ...
  public ab(Context paramContext, List<bi> paramList)
  {
    this.a = paramContext;
    this.b = paramList;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      paramView.c.setText(((bi)this.b.get(paramInt)).getTop());
      paramView.d.setText(((bi)this.b.get(paramInt)).getBottom());
  ...
  public void setData(List<bi> paramList)
  {
    this.b = paramList;
...
/* Location:              /Users/gaoht/Downloads/zirom/classes3-dex2jar.jar!/com/ziroom/ziroomcustomer/newclean/b/ab.class
