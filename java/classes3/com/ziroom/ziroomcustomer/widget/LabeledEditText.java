  ...
  extends RelativeLayout
{
  ...
  public LabeledEditText(Context paramContext)
  {
    super(paramContext);
    this.k = paramContext;
  }
  
  public LabeledEditText(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  @TargetApi(11)
  public LabeledEditText(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  private void a()
  {
    this.c.addTextChangedListener(new TextWatcher()
    {
      public void afterTextChanged(Editable paramAnonymousEditable)
      {
        ...
        if (!LabeledEditText.a(LabeledEditText.this).isFocused())
        {
          localLabeledEditText = LabeledEditText.this;
        ...
        {
          LabeledEditText.a(localLabeledEditText, bool);
          if (LabeledEditText.b(LabeledEditText.this))
          {
            if (TextUtils.isEmpty(LabeledEditText.c(LabeledEditText.this).getText())) {
              break label153;
            }
            if (TextUtils.isEmpty(paramAnonymousEditable)) {
              break;
            }
            LabeledEditText.c(LabeledEditText.this).setVisibility(0);
            paramAnonymousEditable = LabeledEditText.this.getLayoutParams();
            paramAnonymousEditable.height = LabeledEditText.a(LabeledEditText.this, 74.0F);
            LabeledEditText.this.setLayoutParams(paramAnonymousEditable);
          }
          return;
        }
        LabeledEditText.c(LabeledEditText.this).setVisibility(8);
        paramAnonymousEditable = LabeledEditText.this.getLayoutParams();
        paramAnonymousEditable.height = LabeledEditText.a(LabeledEditText.this, 54.0F);
        LabeledEditText.this.setLayoutParams(paramAnonymousEditable);
        return;
        label153:
        LabeledEditText.c(LabeledEditText.this).setVisibility(8);
  ...
  private void b(TypedArray paramTypedArray)
  {
    ...
    for (String str = "";; str = paramTypedArray.getString(2))
    {
      ...
      this.b.setTextSize(0, paramTypedArray.getDimension(12, n.sp2px(this.k, 10.0F)));
  ...
  private void c(TypedArray paramTypedArray)
  {
    ...
    if (!this.j)
    {
      ...
      a();
      this.c.setTextSize(0, paramTypedArray.getDimension(14, n.sp2px(this.k, 15.0F)));
      ...
      ((RelativeLayout.LayoutParams)localObject).topMargin = 6;
    ...
    for (;;)
    {
      this.d.setTextSize(0, paramTypedArray.getDimension(14, n.sp2px(this.k, 15.0F)));
  ...
  private void d(TypedArray paramTypedArray)
  {
    ...
    localLayoutParams.addRule(15);
    localLayoutParams.leftMargin = paramTypedArray.getDimensionPixelSize(4, a(16.0F));
        ...
        if (localObject != null)
        {
          ((c)localObject).addListener(new b()
          {
            public void onAnimationEnd(com.d.a.a paramAnonymousa)
            {
              ...
              paramAnonymousa = LabeledEditText.d(LabeledEditText.this);
              int i;
              if (paramBoolean)
              {
                i = 0;
                paramAnonymousa.setVisibility(i);
                paramAnonymousa = com.d.c.a.a.wrap(LabeledEditText.d(LabeledEditText.this));
                if (!paramBoolean) {
                  break label77;
                }
              }
              ...
              for (float f = 1.0F;; f = 0.0F)
              {
                ...
                if (!paramBoolean) {
                  LabeledEditText.a(LabeledEditText.this).setVisibility(0);
                }
                return;
                i = 8;
                break;
            ...
            public void onAnimationStart(com.d.a.a paramAnonymousa)
            {
              ...
              LabeledEditText.d(LabeledEditText.this).setVisibility(0);
              if (!paramBoolean) {
                LabeledEditText.a(LabeledEditText.this).setVisibility(4);
              }
            }
          });
          ((c)localObject).start();
  ...
  public void addTextChangedListener(a parama)
  {
    if (parama != null)
    {
      ...
      this.c.addTextChangedListener(new TextWatcher()
      {
        public void afterTextChanged(Editable paramAnonymousEditable)
        {
          LabeledEditText localLabeledEditText = LabeledEditText.this;
          if (!TextUtils.isEmpty(paramAnonymousEditable)) {}
          for (boolean bool = true;; bool = false)
          {
            LabeledEditText.a(localLabeledEditText, bool);
            LabeledEditText.e(LabeledEditText.this).afterTextChanged(paramAnonymousEditable);
            return;
          }
        }
        ...
        public void beforeTextChanged(CharSequence paramAnonymousCharSequence, int paramAnonymousInt1, int paramAnonymousInt2, int paramAnonymousInt3)
        {
          LabeledEditText.e(LabeledEditText.this).beforeTextChanged(paramAnonymousCharSequence, paramAnonymousInt1, paramAnonymousInt2, paramAnonymousInt3);
        }
        
        public void onTextChanged(CharSequence paramAnonymousCharSequence, int paramAnonymousInt1, int paramAnonymousInt2, int paramAnonymousInt3)
        {
          LabeledEditText.e(LabeledEditText.this).onTextChanged(paramAnonymousCharSequence, paramAnonymousInt1, paramAnonymousInt2, paramAnonymousInt3);
        }
      });
    }
  }
  ...
  public void setEditTextFocusable(boolean paramBoolean)
  {
        ...
        public void onFocusChange(View paramAnonymousView, boolean paramAnonymousBoolean)
        {
          if (TextUtils.isEmpty(LabeledEditText.this.getText()))
          {
            if (paramAnonymousBoolean) {
              LabeledEditText.a(LabeledEditText.this, true);
            }
          }
          else {
            return;
          }
          LabeledEditText.a(LabeledEditText.this, false);
        }
      });
    }
  }
    ...
    extends TextView
  {
    ...
    private void a()
    {
      // Byte code:
      //   0: aload_0
      //   1: invokevirtual 76	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView:getMaxLines	()I
      //   4: istore 4
      //   6: aload_0
      //   7: getfield 78	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView:e	Ljava/lang/String;
      //   10: astore 7
      //   12: iload 4
      //   14: iconst_m1
      ...
      //   18: aload_0
      //   19: aload 7
      //   21: invokespecial 80	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView:a	(Ljava/lang/String;)Landroid/text/Layout;
      //   24: astore 8
      //   26: aload_0
      //   27: ldc 82
      //   29: invokespecial 80	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView:a	(Ljava/lang/String;)Landroid/text/Layout;
      //   32: astore 9
      //   34: aload 8
      ...
      //   66: istore 5
      //   68: aload_0
      //   69: getfield 78	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView:e	Ljava/lang/String;
      //   72: iconst_0
      //   73: iload 5
      //   75: iconst_0
      //   76: isub
      ...
      //   103: istore 4
      //   105: aload_0
      //   106: getfield 78	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView:e	Ljava/lang/String;
      //   109: iconst_0
      //   110: iload 5
      //   112: iload 4
      //   114: isub
      ...
      //   120: aload_0
      //   121: aload 7
      //   123: invokespecial 80	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView:a	(Ljava/lang/String;)Landroid/text/Layout;
      //   126: iconst_0
      ...
      //   163: invokespecial 80	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView:a	(Ljava/lang/String;)Landroid/text/Layout;
      //   166: iconst_0
      ...
      //   215: aload 7
      //   217: aload_0
      //   218: invokevirtual 120	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView:getText	()Ljava/lang/CharSequence;
      //   221: invokevirtual 124	java/lang/String:equals	(Ljava/lang/Object;)Z
      //   224: ifne +19 -> 243
      //   227: aload_0
      //   228: iconst_1
      //   229: putfield 126	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView:d	Z
      //   232: aload_0
      //   233: aload 7
      //   235: invokevirtual 130	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView:setText	(Ljava/lang/CharSequence;)V
      //   238: aload_0
      //   239: iconst_0
      //   240: putfield 126	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView:d	Z
      //   243: aload_0
      //   244: iconst_0
      //   245: putfield 132	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView:c	Z
      //   248: iload 6
      //   250: aload_0
      //   251: getfield 134	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView:b	Z
      //   254: if_icmpeq +67 -> 321
      //   257: aload_0
      //   258: iload 6
      //   260: putfield 134	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView:b	Z
      //   263: aload_0
      //   264: getfield 34	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView:a	Ljava/util/List;
      ...
      //   291: checkcast 9	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView$a
      //   294: iload 6
      ...
      //   313: aload_0
      //   314: iconst_0
      //   315: putfield 126	com/ziroom/ziroomcustomer/widget/LabeledEditText$EllipsizingTextView:d	Z
      //   318: aload 7
      //   320: athrow
      //   321: return
      //   322: iconst_0
...
/* Location:              /Users/gaoht/Downloads/zirom/classes3-dex2jar.jar!/com/ziroom/ziroomcustomer/widget/LabeledEditText.class
