  ...
  extends LinearLayout
{
  ...
  public TextInputLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = at.obtainStyledAttributes(paramContext, paramAttributeSet, R.styleable.TextInputLayout, paramInt, android.support.design.R.style.Widget_Design_TextInputLayout);
  ...
  private void setEditText(EditText paramEditText)
  {
    ...
    if (this.mCounterView != null) {
      updateCounter(VdsAgent.trackEditTextSilent(this.mEditText).length());
    }
    if (this.mIndicatorArea != null) {
      adjustIndicatorPadding();
    }
  ...
  private void updateEditTextBackground()
  {
    ...
    if (w.canSafelyMutateDrawable(localDrawable2)) {
      localDrawable1 = localDrawable2.mutate();
    }
    if ((this.mErrorShown) && (this.mErrorView != null))
    {
      localDrawable1.setColorFilter(g.getPorterDuffColorFilter(this.mErrorView.getCurrentTextColor(), PorterDuff.Mode.SRC_IN));
      return;
    }
    if ((this.mCounterOverflowed) && (this.mCounterView != null))
    {
      localDrawable1.setColorFilter(g.getPorterDuffColorFilter(this.mCounterView.getCurrentTextColor(), PorterDuff.Mode.SRC_IN));
      return;
    }
  ...
  public void setCounterMaxLength(int paramInt)
  {
    ...
    label39:
    label47:
    for (paramInt = 0;; paramInt = VdsAgent.trackEditTextSilent(this.mEditText).length())
    {
  ...
  void updateLabelState(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    int i;
    boolean bool2;
    if ((this.mEditText != null) && (!TextUtils.isEmpty(VdsAgent.trackEditTextSilent(this.mEditText))))
    {
      i = 1;
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/android/support/design/widget/TextInputLayout.class
