...
final class CollapsingTextHelper
{
  ...
  {
    at localat = at.obtainStyledAttributes(this.mView.getContext(), paramInt, R.styleable.TextAppearance);
    if (localat.hasValue(R.styleable.TextAppearance_android_textColor)) {
      this.mCollapsedTextColor = localat.getColorStateList(R.styleable.TextAppearance_android_textColor);
    }
    if (localat.hasValue(R.styleable.TextAppearance_android_textSize)) {
      this.mCollapsedTextSize = localat.getDimensionPixelSize(R.styleable.TextAppearance_android_textSize, (int)this.mCollapsedTextSize);
    }
    this.mCollapsedShadowColor = localat.getInt(R.styleable.TextAppearance_android_shadowColor, 0);
    this.mCollapsedShadowDx = localat.getFloat(R.styleable.TextAppearance_android_shadowDx, 0.0F);
    this.mCollapsedShadowDy = localat.getFloat(R.styleable.TextAppearance_android_shadowDy, 0.0F);
    this.mCollapsedShadowRadius = localat.getFloat(R.styleable.TextAppearance_android_shadowRadius, 0.0F);
    localat.recycle();
  ...
  void setExpandedTextAppearance(int paramInt)
  {
    at localat = at.obtainStyledAttributes(this.mView.getContext(), paramInt, R.styleable.TextAppearance);
    if (localat.hasValue(R.styleable.TextAppearance_android_textColor)) {
      this.mExpandedTextColor = localat.getColorStateList(R.styleable.TextAppearance_android_textColor);
    }
    if (localat.hasValue(R.styleable.TextAppearance_android_textSize)) {
      this.mExpandedTextSize = localat.getDimensionPixelSize(R.styleable.TextAppearance_android_textSize, (int)this.mExpandedTextSize);
    }
    this.mExpandedShadowColor = localat.getInt(R.styleable.TextAppearance_android_shadowColor, 0);
    this.mExpandedShadowDx = localat.getFloat(R.styleable.TextAppearance_android_shadowDx, 0.0F);
    this.mExpandedShadowDy = localat.getFloat(R.styleable.TextAppearance_android_shadowDy, 0.0F);
    this.mExpandedShadowRadius = localat.getFloat(R.styleable.TextAppearance_android_shadowRadius, 0.0F);
    localat.recycle();
    if (Build.VERSION.SDK_INT >= 16) {
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/android/support/design/widget/CollapsingTextHelper.class
