...
public class at
{
  ...
  private at(Context paramContext, TypedArray paramTypedArray)
  {
    this.a = paramContext;
    this.b = paramTypedArray;
  }
  
  public static at obtainStyledAttributes(Context paramContext, int paramInt, int[] paramArrayOfInt)
  {
    return new at(paramContext, paramContext.obtainStyledAttributes(paramInt, paramArrayOfInt));
  }
  
  public static at obtainStyledAttributes(Context paramContext, AttributeSet paramAttributeSet, int[] paramArrayOfInt)
  {
    return new at(paramContext, paramContext.obtainStyledAttributes(paramAttributeSet, paramArrayOfInt));
  }
  
  public static at obtainStyledAttributes(Context paramContext, AttributeSet paramAttributeSet, int[] paramArrayOfInt, int paramInt1, int paramInt2)
  {
    return new at(paramContext, paramContext.obtainStyledAttributes(paramAttributeSet, paramArrayOfInt, paramInt1, paramInt2));
  }
  ...
  public ColorStateList getColorStateList(int paramInt)
  {
    if (this.b.hasValue(paramInt))
    {
      ...
      if (i != 0)
      {
        ColorStateList localColorStateList = b.getColorStateList(this.a, i);
  ...
  public Drawable getDrawableIfKnown(int paramInt)
  {
    if (this.b.hasValue(paramInt))
    {
      ...
      if (paramInt != 0) {
        return g.get().a(this.a, paramInt, true);
      }
    }
    return null;
  }
  ...
  public Typeface getFont(int paramInt1, int paramInt2, TextView paramTextView)
  {
    ...
    return ResourcesCompat.getFont(this.a, paramInt1, this.c, paramInt2, paramTextView);
  }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/android/support/v7/widget/at.class
