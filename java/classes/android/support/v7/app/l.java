...
class l
{
  ...
  private static Context a(Context paramContext, AttributeSet paramAttributeSet, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (int i = paramAttributeSet.getResourceId(R.styleable.View_android_theme, 0);; i = 0)
    {
      ...
      if (j != 0) {
        ...
        {
          paramAttributeSet = paramContext;
          if (((d)paramContext).getThemeResId() == j) {}
        }
        else
        {
  ...
  private View a(Context paramContext, String paramString, AttributeSet paramAttributeSet)
  {
    ...
    //   3: aload_2
    //   4: ldc 102
    //   6: invokevirtual 106	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   9: ifeq +14 -> 23
    //   12: aload_3
    //   13: aconst_null
    //   14: ldc 108
    ...
    //   67: iload 4
    //   69: aaload
    //   70: invokespecial 119	android/support/v7/app/l:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    //   73: astore_2
    //   74: aload_2
    //   75: ifnull +19 -> 94
    //   78: aload_0
    ...
    //   121: aload 5
    //   123: aconst_null
    //   124: invokespecial 119	android/support/v7/app/l:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    //   127: astore_1
    //   128: aload_0
    ...
    //   161: astore_1
    //   162: aload_0
    //   163: getfield 52	android/support/v7/app/l:e	[Ljava/lang/Object;
    //   166: iconst_0
    //   167: aconst_null
    //   168: aastore
    //   169: aload_0
    //   170: getfield 52	android/support/v7/app/l:e	[Ljava/lang/Object;
    //   173: iconst_1
    //   174: aconst_null
    //   175: aastore
    //   176: aload_1
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/android/support/v7/app/l.class
