  ...
  extends TypefaceCompatBaseImpl
{
  ...
  public android.graphics.Typeface createFromFontInfo(android.content.Context paramContext, android.os.CancellationSignal paramCancellationSignal, android.support.v4.provider.FontsContractCompat.FontInfo[] paramArrayOfFontInfo, int paramInt)
  {
    ...
    //   49: ifne +151 -> 200
    //   52: new 104	java/io/FileInputStream
    //   55: dup
    //   56: aload_3
    //   57: invokevirtual 108	android/os/ParcelFileDescriptor:getFileDescriptor	()Ljava/io/FileDescriptor;
    //   60: invokespecial 111	java/io/FileInputStream:<init>	(Ljava/io/FileDescriptor;)V
    //   63: astore 5
    //   65: aload_0
    //   66: aload_1
    //   67: aload 5
    //   69: invokespecial 115	android/support/v4/graphics/TypefaceCompatBaseImpl:createFromInputStream	(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
    //   72: astore_1
    //   73: aload 5
    //   75: ifnull +12 -> 87
    //   78: iconst_0
    //   79: ifeq +52 -> 131
    //   82: aload 5
    //   84: invokevirtual 118	java/io/FileInputStream:close	()V
    //   87: aload_3
    //   88: ifnull +11 -> 99
    //   91: iconst_0
    //   92: ifeq +62 -> 154
    //   95: aload_3
    //   96: invokevirtual 119	android/os/ParcelFileDescriptor:close	()V
    //   99: aload_1
    //   100: areturn
    //   101: astore_1
    //   102: new 121	java/lang/NullPointerException
    //   105: dup
    //   106: invokespecial 122	java/lang/NullPointerException:<init>	()V
    //   109: athrow
    //   110: astore_2
    //   111: aload_2
    //   112: athrow
    ...
    //   119: ifnull +125 -> 244
    //   122: aload_3
    //   123: invokevirtual 119	android/os/ParcelFileDescriptor:close	()V
    //   126: aload_1
    //   127: athrow
    //   128: astore_1
    //   129: aconst_null
    //   130: areturn
    //   131: aload 5
    //   133: invokevirtual 118	java/io/FileInputStream:close	()V
    //   136: goto -49 -> 87
    //   139: astore_1
    //   140: aconst_null
    //   141: astore_2
    //   142: goto -28 -> 114
    //   145: astore_1
    //   146: new 121	java/lang/NullPointerException
    //   149: dup
    //   150: invokespecial 122	java/lang/NullPointerException:<init>	()V
    //   153: athrow
    //   154: aload_3
    //   155: invokevirtual 119	android/os/ParcelFileDescriptor:close	()V
    //   158: goto -59 -> 99
    //   161: astore_1
    //   162: aload_1
    //   163: athrow
    ...
    //   171: ifnull +21 -> 192
    //   174: aload 5
    //   176: invokevirtual 118	java/io/FileInputStream:close	()V
    //   179: aload_2
    //   180: athrow
    //   181: astore 5
    //   183: aload_1
    //   184: aload 5
    //   186: invokevirtual 126	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   189: goto -10 -> 179
    //   192: aload 5
    //   194: invokevirtual 118	java/io/FileInputStream:close	()V
    //   197: goto -18 -> 179
    //   200: aload_2
    //   201: invokestatic 132	android/graphics/Typeface:createFromFile	(Ljava/io/File;)Landroid/graphics/Typeface;
    //   204: astore_1
    //   205: aload_3
    //   206: ifnull +11 -> 217
    //   209: iconst_0
    //   210: ifeq +18 -> 228
    //   213: aload_3
    //   214: invokevirtual 119	android/os/ParcelFileDescriptor:close	()V
    //   217: aload_1
    //   218: areturn
    //   219: astore_1
    //   220: new 121	java/lang/NullPointerException
    //   223: dup
    //   224: invokespecial 122	java/lang/NullPointerException:<init>	()V
    //   227: athrow
    //   228: aload_3
    //   229: invokevirtual 119	android/os/ParcelFileDescriptor:close	()V
    //   232: goto -15 -> 217
    //   235: astore_3
    //   236: aload_2
    //   237: aload_3
    //   238: invokevirtual 126	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   241: goto -115 -> 126
    //   244: aload_3
    //   245: invokevirtual 119	android/os/ParcelFileDescriptor:close	()V
    //   248: goto -122 -> 126
    //   251: astore_2
    //   252: aconst_null
    //   253: astore_1
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/android/support/v4/graphics/TypefaceCompatApi21Impl.class
