...
class DocumentsContractApi19
{
  ...
  public static boolean exists(Context paramContext, Uri paramUri)
  {
    ...
    //   6: aload_1
    //   7: iconst_1
    //   8: anewarray 45	java/lang/String
    //   11: dup
    //   12: iconst_0
    //   13: ldc 74
    //   15: aastore
    ...
    //   17: aconst_null
    //   18: aconst_null
    //   19: invokevirtual 80	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   22: astore_1
    //   23: aload_1
    //   24: astore_0
    //   25: aload_1
    ...
    //   37: istore_3
    //   38: aload_1
    //   39: invokestatic 88	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   42: iload_3
    //   43: ireturn
    //   44: iconst_0
    //   45: istore_3
    ...
    //   54: astore_0
    //   55: ldc 11
    //   57: new 90	java/lang/StringBuilder
    //   60: dup
    //   61: invokespecial 91	java/lang/StringBuilder:<init>	()V
    //   64: ldc 93
    //   66: invokevirtual 97	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   69: aload 4
    //   71: invokevirtual 100	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   74: invokevirtual 104	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   77: invokestatic 110	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   80: pop
    //   81: aload_1
    //   82: invokestatic 88	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   85: iconst_0
    //   86: ireturn
    //   87: astore_1
    //   88: aconst_null
    //   89: astore_0
    //   90: aload_0
    //   91: invokestatic 88	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   94: aload_1
    //   95: athrow
    //   96: astore_1
    //   97: goto -7 -> 90
  ...
  private static long queryForLong(Context paramContext, Uri paramUri, String paramString, long paramLong)
  {
    ...
    //   16: aconst_null
    //   17: aconst_null
    //   18: invokevirtual 80	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   21: astore_1
    //   22: aload_1
    //   23: astore_0
    //   24: aload_1
    ...
    //   54: lstore 5
    //   56: aload_1
    //   57: invokestatic 88	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   60: lload 5
    //   62: lreturn
    //   63: aload_1
    //   64: invokestatic 88	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   67: lload_3
    //   68: lreturn
    //   69: astore_2
    //   70: aconst_null
    ...
    //   88: aload_2
    //   89: invokevirtual 100	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   92: invokevirtual 104	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   95: invokestatic 110	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   98: pop
    //   99: aload_1
    //   100: invokestatic 88	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   103: lload_3
    //   104: lreturn
    //   105: astore_1
    //   106: aconst_null
  ...
  private static String queryForString(Context paramContext, Uri paramUri, String paramString1, String paramString2)
  {
    ...
    //   54: astore_2
    //   55: aload_1
    //   56: invokestatic 88	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   59: aload_2
    //   60: areturn
    //   61: aload_1
    //   62: invokestatic 88	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   65: aload_3
    //   66: areturn
    //   67: astore_2
    //   68: aconst_null
    ...
    //   93: invokestatic 110	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   96: pop
    //   97: aload_1
    //   98: invokestatic 88	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   101: aload_3
    //   102: areturn
    //   103: astore_1
    //   104: aconst_null
    //   105: astore_0
    //   106: aload_0
    //   107: invokestatic 88	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   110: aload_1
    //   111: athrow
    //   112: astore_1
    //   113: goto -7 -> 106
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/android/support/v4/provider/DocumentsContractApi19.class
