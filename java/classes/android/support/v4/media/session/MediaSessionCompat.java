      ...
      public void onCommand(String paramString, Bundle paramBundle, ResultReceiver paramResultReceiver)
      {
        ...
        try
        {
          if (paramString.equals("android.support.v4.media.session.command.GET_EXTRA_BINDER"))
          {
            ...
            if (paramString == null) {}
            for (paramString = (String)localObject;; paramString = paramString.asBinder())
            {
        ...
        label301:
        label302:
        for (paramString = (MediaSessionCompat.QueueItem)MediaSessionCompat.MediaSessionImplApi21.access$200(paramString).get(i);; paramString = null)
        {
          if (paramString != null)
          {
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/android/support/v4/media/session/MediaSessionCompat.class
