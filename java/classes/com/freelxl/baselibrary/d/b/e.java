...
public abstract class e
{
  ...
  protected Call a(String paramString, Callback paramCallback)
  {
    ...
    for (paramString = ((OkHttpClient)localObject).newCall(paramString);; paramString = OkHttp3Instrumentation.newCall((OkHttpClient)localObject, paramString))
    {
      ...
      if ((paramCallback instanceof com.freelxl.baselibrary.d.c.a)) {
        ((com.freelxl.baselibrary.d.c.a)paramCallback).onStart();
      }
      return paramString;
    }
  }
  ...
  protected OkHttpClient a()
  {
    ...
    if (this.g * this.f > 0)
    {
      localObject1 = com.freelxl.baselibrary.d.a.getInstance().newBuilder();
      if (this.g > 0) {
    ...
    if (this.e != null) {
      localObject2 = com.freelxl.baselibrary.d.a.a.addProgressResponseListener((OkHttpClient)localObject1, this.e);
    }
  ...
  protected void a(String paramString, Request.Builder paramBuilder)
  {
    if (this.d != null)
    {
      if (this.b != null)
      {
        paramBuilder.method(paramString, com.freelxl.baselibrary.d.a.a.addProgressRequestListener(this.b.build(), this.d));
        return;
      }
      if (this.c != null)
      {
        paramBuilder.method(paramString, com.freelxl.baselibrary.d.a.a.addProgressRequestListener(this.c, this.d));
        return;
      }
      localBuilder = new FormBody.Builder();
      a(localBuilder, this.i);
      paramBuilder.method(paramString, com.freelxl.baselibrary.d.a.a.addProgressRequestListener(localBuilder.build(), this.d));
      return;
    }
    if (this.b != null)
    {
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/com/freelxl/baselibrary/d/b/e.class
