...
import com.freelxl.baselibrary.d.b.d;
...
public class a
{
  ...
  public static com.freelxl.baselibrary.d.b.a delete(String paramString)
  {
    return new com.freelxl.baselibrary.d.b.a().url(paramString);
  }
  
  public static com.freelxl.baselibrary.d.b.b get(String paramString)
  {
    return new com.freelxl.baselibrary.d.b.b().url(paramString);
  }
  ...
  public static void isMock(boolean paramBoolean, File paramFile)
  {
    ...
    try
    {
      ...
      getInstanceBuilder().addInterceptor(new com.freelxl.baselibrary.d.e.c(paramFile));
      return;
    }
  ...
  {
    if (paramBoolean) {
      getInstanceBuilder().addInterceptor(new com.freelxl.baselibrary.d.e.b());
    }
  }
  
  public static com.freelxl.baselibrary.d.b.c post(String paramString)
  {
    return new com.freelxl.baselibrary.d.b.c().url(paramString);
  }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/com/freelxl/baselibrary/d/a.class
