...
public class b
{
  ...
  public static String a(byte[] paramArrayOfByte, int paramInt)
  {
    try
    {
      paramArrayOfByte = new String(a(paramArrayOfByte, 0, paramArrayOfByte.length, paramInt), "US-ASCII");
  ...
  public static byte[] a(String paramString)
  {
    ...
    paramString = new b(0, new byte[i * 3 / 4]);
    if (!paramString.a(arrayOfByte, 0, i)) {
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/com/f/a/a/a/b.class
