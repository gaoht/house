...
public class ImagePipelineFactory
{
  ...
  private ImageDecoder getImageDecoder()
  {
    ...
    for (;;)
    {
      ...
      label91:
      this.mImageDecoder = new DefaultImageDecoder(localAnimatedImageFactory, getPlatformDecoder(), this.mConfig.getBitmapConfig(), this.mConfig.getImageDecoderConfig().getCustomImageDecoders());
  ...
  public MediaVariationsIndex getMediaVariationsIndex()
  {
    ...
    label69:
    for (Object localObject = new MediaVariationsIndexDatabase(this.mConfig.getContext(), this.mConfig.getExecutorSupplier().forLocalStorageRead(), this.mConfig.getExecutorSupplier().forLocalStorageWrite());; localObject = new NoOpMediaVariationsIndex())
    {
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/com/facebook/imagepipeline/core/ImagePipelineFactory.class
