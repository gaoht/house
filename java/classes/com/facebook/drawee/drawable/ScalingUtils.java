...
public class ScalingUtils
{
    ...
    implements ScalingUtils.ScaleType, ScalingUtils.StatefulScaleType
  {
    ...
    public Matrix getTransform(Matrix paramMatrix, Rect paramRect, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2)
    {
      ...
      for (Rect localRect = this.mBoundsFrom;; localRect = paramRect)
      {
  ...
  public static abstract interface ScaleType
  {
    ...
    public static final ScaleType CENTER_CROP = ScalingUtils.ScaleTypeCenterCrop.INSTANCE;
    ...
    public static final ScaleType FOCUS_CROP = ScalingUtils.ScaleTypeFocusCrop.INSTANCE;
    ...
    extends ScalingUtils.AbstractScaleType
  {
    ...
    public void getTransformImpl(Matrix paramMatrix, Rect paramRect, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
    {
      ...
      for (;;)
      {
        ...
        paramFloat1 = paramRect.top + (paramRect.height() - paramInt2 * paramFloat3) * 0.5F;
    ...
    extends ScalingUtils.AbstractScaleType
  {
    ...
    public void getTransformImpl(Matrix paramMatrix, Rect paramRect, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
    {
      if (paramFloat4 > paramFloat3)
      {
        ...
        paramFloat2 = paramRect.left + Math.max(Math.min(paramFloat2 * 0.5F - paramFloat3 * paramFloat4 * paramFloat1, 0.0F), paramRect.width() - paramInt1 * paramFloat4);
        paramFloat1 = paramRect.top;
      }
      for (;;)
      {
        ...
        paramMatrix.postTranslate((int)(paramFloat2 + 0.5F), (int)(paramFloat1 + 0.5F));
        return;
        paramFloat4 = paramRect.left;
        paramFloat1 = paramRect.height();
        float f1 = paramInt2;
        float f2 = paramRect.top;
        paramFloat1 = Math.max(Math.min(paramFloat1 * 0.5F - f1 * paramFloat3 * paramFloat2, 0.0F), paramRect.height() - paramInt2 * paramFloat3) + f2;
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/com/facebook/drawee/drawable/ScalingUtils.class
