  ...
  protected void submitRequest()
  {
    ...
    localObject = new BaseDataSubscriber()
    {
      ...
      public void onNewResultImpl(DataSource<T> paramAnonymousDataSource)
      {
        ...
        if ((AbstractDraweeController.this.mInitTrace != null) && ((localObject instanceof CloseableReference))) {
          ((CloseableReference)localObject).setUnclosedRelevantTrance(AbstractDraweeController.this.mInitTrace);
        }
        if (localObject != null) {
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/com/facebook/drawee/controller/AbstractDraweeController.class
