  ...
  extends Drawable
{
  ...
  private void addDebugText(Canvas paramCanvas, String paramString, @Nullable Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      return;
      paramCanvas.drawText(String.format(paramString, paramVarArgs), this.mCurrentTextXPx, this.mCurrentTextYPx, this.mPaint);
    }
  }
  ...
  int determineOverlayColor(int paramInt1, int paramInt2, @Nullable ScalingUtils.ScaleType paramScaleType)
  {
    ...
    if ((j <= 0) || (i <= 0) || (paramInt1 <= 0) || (paramInt2 <= 0)) {
      return 1727284022;
    }
    if (paramScaleType != null)
    {
      ...
      int m = (int)this.mRectF.width();
      int k = (int)this.mRectF.height();
      j = Math.min(j, m);
      i = Math.min(i, k);
    }
    for (;;)
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/com/facebook/drawee/debug/DebugControllerOverlayDrawable.class
