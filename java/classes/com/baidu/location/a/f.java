...
public class f
{
  ...
  private static boolean a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    } while ((paramInt3 >= 1) && (paramInt3 <= paramInt1 + 1) && (paramInt3 <= j.ab));
    return false;
  }
  
  private boolean a(Location paramLocation, int paramInt1, int paramInt2)
  {
    if ((paramLocation == null) || (!j.X) || (!this.q)) {
      return false;
    }
    if (j.Z < 5)
    {
    ...
    long l2 = h;
    if ((paramLocation[0] >= j.Z) || (l1 - l2 >= j.aa))
    {
      if (d == null)
      {
        f += 1;
  ...
  private boolean a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localRandomAccessFile.seek(0L);
          localRandomAccessFile.writeInt(j.ab);
          if ((i2 == 0) || (i2 == 1)) {
            localRandomAccessFile.writeInt(2);
          }
          localRandomAccessFile.seek(8L);
  ...
  {
    return a(paramLocation, j.Z, j.aa);
  }
}


/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/com/baidu/location/a/f.class
