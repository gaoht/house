...
public class b
{
  ...
  private CellLocation a(List<?> paramList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject7 = j.a(localObject3, "getCellIdentity", new Object[0]);
        if (localObject7 == null)
        {
          break label56;
      ...
      try
      {
        i3 = j.b(localObject7, "getSystemId", new Object[0]);
        i4 = j.b(localObject7, "getNetworkId", new Object[0]);
        i5 = j.b(localObject7, "getBasestationId", new Object[0]);
        i6 = j.b(localObject7, "getLongitude", new Object[0]);
        ((CdmaCellLocation)localObject3).setCellLocationData(i5, j.b(localObject7, "getLatitude", new Object[0]), i6, i3, i4);
      ...
      if (i1 == 3)
      {
        i3 = j.b(localObject7, "getTac", new Object[0]);
        i4 = j.b(localObject7, "getCi", new Object[0]);
      ...
      int i3 = j.b(localObject7, "getLac", new Object[0]);
      int i4 = j.b(localObject7, "getCid", new Object[0]);
  ...
  private void k()
  {
    ...
    {
      localObject = a(this.d.getCellLocation());
      if ((localObject == null) || (!((a)localObject).b()))
      {
        localObject = l();
        if (localObject != null)
  ...
  private CellLocation l()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 66	com/baidu/location/b/b:e	Ljava/lang/Object;
    //   4: astore_1
    //   5: aload_1
    //   6: ifnonnull +5 -> 11
    //   9: aconst_null
    //   10: areturn
    //   11: aload_0
    //   12: invokespecial 531	com/baidu/location/b/b:m	()Ljava/lang/Class;
    //   15: astore_2
    //   16: aload_2
    //   17: aload_1
    //   18: invokevirtual 124	java/lang/Class:isInstance	(Ljava/lang/Object;)Z
    //   21: ifeq +174 -> 195
    //   24: aload_2
    //   25: aload_1
    //   26: invokevirtual 128	java/lang/Class:cast	(Ljava/lang/Object;)Ljava/lang/Object;
    //   29: astore_3
    //   30: aload_3
    //   31: ldc_w 532
    //   34: iconst_0
    //   35: anewarray 4	java/lang/Object
    //   38: invokestatic 135	com/baidu/location/d/j:a	(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;
    //   41: astore_1
    //   42: aload_1
    //   43: astore_2
    //   44: aload_1
    ...
    //   57: iconst_0
    //   58: iconst_1
    //   59: invokestatic 186	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   62: aastore
    //   63: invokestatic 135	com/baidu/location/d/j:a	(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;
    //   66: astore_2
    //   67: aload_2
    //   68: astore_1
    //   69: aload_2
    ...
    //   82: iconst_0
    //   83: iconst_1
    //   84: invokestatic 186	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   87: aastore
    //   88: invokestatic 135	com/baidu/location/d/j:a	(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;
    //   91: astore_1
    //   92: aload_1
    //   93: astore_2
    //   94: aload_1
    ...
    //   106: invokestatic 135	com/baidu/location/d/j:a	(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;
    //   109: checkcast 88	java/util/List
    //   112: astore_1
    //   113: aload_0
    //   114: aload_1
    //   115: invokespecial 537	com/baidu/location/b/b:a	(Ljava/util/List;)Landroid/telephony/CellLocation;
    //   118: astore_1
    //   119: aload_1
    //   120: astore_2
    //   121: aload_1
    ...
    //   126: ifnull +64 -> 190
    //   129: aload_2
    //   130: checkcast 539	android/telephony/CellLocation
    //   133: astore_1
    //   134: aload_1
    //   135: areturn
    //   136: astore_1
  ...
  private a n()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        Object localObject1 = this.d.getAllCellInfo();
        if ((localObject1 == null) || (((List)localObject1).size() <= 0)) {
          continue;
        }
  ...
  public void b()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 79	com/baidu/location/b/b:j	Z
    //   6: istore_2
    //   7: iload_2
    //   8: iconst_1
    //   9: if_icmpne +6 -> 15
    ...
    //   13: monitorexit
    //   14: return
    //   15: getstatic 623	com/baidu/location/f:isServing	Z
    //   18: ifeq -6 -> 12
    //   21: aload_0
    //   22: invokestatic 627	com/baidu/location/f:getServiceContext	()Landroid/content/Context;
    //   25: ldc_w 629
    //   28: invokevirtual 635	android/content/Context:getSystemService	(Ljava/lang/String;)Ljava/lang/Object;
    //   31: checkcast 297	android/telephony/TelephonyManager
    //   34: putfield 64	com/baidu/location/b/b:d	Landroid/telephony/TelephonyManager;
    //   37: aload_0
    //   38: new 493	java/util/LinkedList
    //   41: dup
    //   42: invokespecial 494	java/util/LinkedList:<init>	()V
    //   45: putfield 75	com/baidu/location/b/b:h	Ljava/util/List;
    //   48: aload_0
    //   49: new 6	com/baidu/location/b/b$a
    //   52: dup
    //   53: aload_0
    //   54: invokespecial 637	com/baidu/location/b/b$a:<init>	(Lcom/baidu/location/b/b;)V
    //   57: putfield 77	com/baidu/location/b/b:i	Lcom/baidu/location/b/b$a;
    //   60: aload_0
    //   61: invokespecial 639	com/baidu/location/b/b:i	()V
    //   64: aload_0
    //   65: getfield 64	com/baidu/location/b/b:d	Landroid/telephony/TelephonyManager;
    //   68: ifnull -56 -> 12
    //   71: aload_0
    //   72: getfield 77	com/baidu/location/b/b:i	Lcom/baidu/location/b/b$a;
    //   75: astore_3
    //   76: aload_3
    //   77: ifnull -65 -> 12
    //   80: aload_0
    //   81: getfield 64	com/baidu/location/b/b:d	Landroid/telephony/TelephonyManager;
    //   84: aload_0
    //   85: getfield 77	com/baidu/location/b/b:i	Lcom/baidu/location/b/b$a;
    //   88: sipush 272
    //   91: invokevirtual 643	android/telephony/TelephonyManager:listen	(Landroid/telephony/PhoneStateListener;I)V
    //   94: aload_0
    //   95: invokespecial 541	com/baidu/location/b/b:o	()I
    //   98: istore_1
    //   99: iload_1
    //   100: tableswitch	default:+28->128, 0:+82->182, 1:+41->141, 2:+66->166
    //   128: aload_0
    //   129: iconst_1
    //   130: putfield 79	com/baidu/location/b/b:j	Z
    //   133: goto -121 -> 12
    //   136: astore_3
    //   137: aload_0
    //   138: monitorexit
    ...
    //   140: athrow
    //   141: aload_0
    //   142: invokestatic 627	com/baidu/location/f:getServiceContext	()Landroid/content/Context;
    //   145: ldc_w 645
    //   148: invokestatic 648	com/baidu/location/d/j:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/Object;
    //   151: putfield 66	com/baidu/location/b/b:e	Ljava/lang/Object;
    //   154: goto -26 -> 128
    //   157: astore_3
    //   158: aload_0
    //   159: aconst_null
    //   160: putfield 66	com/baidu/location/b/b:e	Ljava/lang/Object;
    //   163: goto -35 -> 128
    //   166: aload_0
    //   167: invokestatic 627	com/baidu/location/f:getServiceContext	()Landroid/content/Context;
    //   170: ldc_w 650
    //   173: invokestatic 648	com/baidu/location/d/j:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/Object;
    //   176: putfield 66	com/baidu/location/b/b:e	Ljava/lang/Object;
    //   179: goto -51 -> 128
    //   182: aload_0
    //   183: invokestatic 627	com/baidu/location/f:getServiceContext	()Landroid/content/Context;
    //   186: ldc_w 650
    //   189: invokestatic 648	com/baidu/location/d/j:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/Object;
    //   192: putfield 66	com/baidu/location/b/b:e	Ljava/lang/Object;
    //   195: goto -67 -> 128
    //   198: astore_3
    //   199: goto -105 -> 94
    // Local variable table:
  ...
  public void c()
  {
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 77	com/baidu/location/b/b:i	Lcom/baidu/location/b/b$a;
    //   18: ifnull +22 -> 40
    //   21: aload_0
    //   22: getfield 64	com/baidu/location/b/b:d	Landroid/telephony/TelephonyManager;
    //   25: ifnull +15 -> 40
    //   28: aload_0
    //   29: getfield 64	com/baidu/location/b/b:d	Landroid/telephony/TelephonyManager;
    //   32: aload_0
    //   33: getfield 77	com/baidu/location/b/b:i	Lcom/baidu/location/b/b$a;
    //   36: iconst_0
    //   37: invokevirtual 643	android/telephony/TelephonyManager:listen	(Landroid/telephony/PhoneStateListener;I)V
    //   40: aload_0
    //   41: aconst_null
    //   42: putfield 77	com/baidu/location/b/b:i	Lcom/baidu/location/b/b$a;
    //   45: aload_0
    //   46: aconst_null
    //   47: putfield 64	com/baidu/location/b/b:d	Landroid/telephony/TelephonyManager;
    //   50: aload_0
    //   51: getfield 75	com/baidu/location/b/b:h	Ljava/util/List;
    //   54: invokeinterface 403 1 0
    //   59: aload_0
    //   60: aconst_null
    //   61: putfield 75	com/baidu/location/b/b:h	Ljava/util/List;
    //   64: aload_0
    //   65: invokespecial 400	com/baidu/location/b/b:j	()V
    //   68: aload_0
    //   69: iconst_0
    //   70: putfield 79	com/baidu/location/b/b:j	Z
    //   73: goto -62 -> 11
    //   76: astore_2
    //   77: aload_0
    //   78: monitorexit
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/com/baidu/location/b/b.class
