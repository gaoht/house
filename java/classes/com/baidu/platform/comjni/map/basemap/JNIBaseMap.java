...
public class JNIBaseMap
{
  ...
  public static native void SetMapCustomEnable(long paramLong, boolean paramBoolean);
  ...
  public native boolean Init(long paramLong, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7);
  
  public native boolean IsBaseIndoorMapMode(long paramLong);
  
  public native boolean LayersIsShow(long paramLong1, long paramLong2);
  
  public native void OnBackground(long paramLong);
  
  public native void OnForeground(long paramLong);
  ...
  public native void ShowBaseIndoorMap(long paramLong, boolean paramBoolean);
  ...
  public native boolean SwitchBaseIndoorMapFloor(long paramLong, String paramString1, String paramString2);
  ...
  public native void addOverlayItems(long paramLong, Bundle[] paramArrayOfBundle, int paramInt);
  ...
  public native String getCompassPosition(long paramLong1, long paramLong2);
  
  public native Bundle getDrawingMapStatus(long paramLong);
  
  public native Bundle getMapStatusLimits(long paramLong);
  
  public native String getfocusedBaseIndoorMapInfo(long paramLong);
  ...
  public native void setMapStatusLimits(long paramLong, Bundle paramBundle);
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/com/baidu/platform/comjni/map/basemap/JNIBaseMap.class
