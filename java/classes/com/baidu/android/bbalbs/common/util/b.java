...
public final class b
{
  ...
  private static String a(File paramFile)
  {
    ...
    //   0: aconst_null
    //   1: astore 4
    //   3: new 46	java/io/FileReader
    //   6: dup
    //   7: aload_0
    //   8: invokespecial 49	java/io/FileReader:<init>	(Ljava/io/File;)V
    //   11: astore_2
    //   12: aload_2
    //   13: astore_0
    //   14: sipush 8192
    ...
    //   20: aload_2
    //   21: astore_0
    //   22: new 51	java/io/CharArrayWriter
    //   25: dup
    //   26: invokespecial 52	java/io/CharArrayWriter:<init>	()V
    //   29: astore 5
    //   31: aload_2
    //   32: astore_0
    //   33: aload_2
    //   34: aload_3
    //   35: invokevirtual 56	java/io/FileReader:read	([C)I
    //   38: istore_1
    //   39: iload_1
    //   40: ifle +39 -> 79
    //   43: aload_2
    ...
    //   48: iconst_0
    //   49: iload_1
    //   50: invokevirtual 60	java/io/CharArrayWriter:write	([CII)V
    //   53: goto -22 -> 31
    //   56: astore_3
    //   57: aload_2
    //   58: astore_0
    //   59: aload_3
    //   60: invokestatic 63	com/baidu/android/bbalbs/common/util/b:b	(Ljava/lang/Throwable;)V
    //   63: aload 4
    //   65: astore_0
    //   66: aload_2
    //   67: ifnull +10 -> 77
    //   70: aload_2
    //   71: invokevirtual 66	java/io/FileReader:close	()V
    //   74: aload 4
    //   76: astore_0
    //   77: aload_0
    //   78: areturn
    ...
    //   80: astore_0
    //   81: aload 5
    //   83: invokevirtual 69	java/io/CharArrayWriter:toString	()Ljava/lang/String;
    //   86: astore_3
    //   87: aload_3
    //   88: astore_0
    //   89: aload_2
    //   90: ifnull -13 -> 77
    //   93: aload_2
    //   94: invokevirtual 66	java/io/FileReader:close	()V
    //   97: aload_3
    //   98: areturn
    //   99: astore_0
    //   100: aload_0
    //   101: invokestatic 63	com/baidu/android/bbalbs/common/util/b:b	(Ljava/lang/Throwable;)V
    //   104: aload_3
    //   105: areturn
    //   106: astore_0
    //   107: aload_0
    //   108: invokestatic 63	com/baidu/android/bbalbs/common/util/b:b	(Ljava/lang/Throwable;)V
    //   111: aconst_null
    //   112: areturn
    //   113: astore_2
    //   114: aconst_null
    ...
    //   117: ifnull +7 -> 124
    //   120: aload_0
    //   121: invokevirtual 66	java/io/FileReader:close	()V
    //   124: aload_2
    //   125: athrow
    //   126: astore_0
    //   127: aload_0
    //   128: invokestatic 63	com/baidu/android/bbalbs/common/util/b:b	(Ljava/lang/Throwable;)V
    //   131: goto -7 -> 124
    //   134: astore_2
    //   135: goto -19 -> 116
    //   138: astore_3
            ...
            try
            {
              ...
              if (paramBoolean)
              {
                ...
                if (!TextUtils.isEmpty((CharSequence)localObject2))
                {
                  ...
                  {
                    localObject2 = a(com.baidu.android.bbalbs.common.a.b.a(((String)localObject2).getBytes()), this.c);
  ...
  private void a()
  {
    ...
    //   31: ifnull +7 -> 38
    //   34: aload_1
    //   35: invokevirtual 311	java/io/ByteArrayInputStream:close	()V
    //   38: return
    //   39: astore_1
    //   40: aload_1
    //   41: invokestatic 63	com/baidu/android/bbalbs/common/util/b:b	(Ljava/lang/Throwable;)V
    //   44: return
    //   45: astore_1
    //   46: aconst_null
    //   47: astore_1
    ...
    //   49: ifnull -11 -> 38
    //   52: aload_1
    //   53: invokevirtual 311	java/io/ByteArrayInputStream:close	()V
    //   56: return
    //   57: astore_1
    //   58: aload_1
    //   59: invokestatic 63	com/baidu/android/bbalbs/common/util/b:b	(Ljava/lang/Throwable;)V
    //   62: return
    //   63: astore_1
    //   64: aload_2
    //   65: ifnull +7 -> 72
    //   68: aload_2
    //   69: invokevirtual 311	java/io/ByteArrayInputStream:close	()V
    //   72: aload_1
    //   73: athrow
    //   74: astore_2
    //   75: aload_2
    //   76: invokestatic 63	com/baidu/android/bbalbs/common/util/b:b	(Ljava/lang/Throwable;)V
    //   79: goto -7 -> 72
    //   82: astore_3
    //   83: aload_1
    //   84: astore_2
              ...
              for (i = 1;; i = j)
              {
                if (localObject1 == null)
                {
                  ...
                  if (Build.VERSION.SDK_INT < 23)
                  {
                    ...
                    ((b)localObject3).a = com.baidu.android.bbalbs.common.a.c.a(((String)localObject1).getBytes(), true);
  ...
  private b d(String paramString)
  {
    ...
    //   0: iconst_0
    //   1: istore_3
    //   2: getstatic 451	android/os/Build$VERSION:SDK_INT	I
    //   5: bipush 23
    //   7: if_icmpge +18 -> 25
    //   10: iconst_1
    //   11: istore_2
    ...
    //   30: ldc 79
    //   32: astore 6
    //   34: new 391	java/io/File
    //   37: dup
    //   38: invokestatic 484	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   41: ldc_w 597
    //   44: invokespecial 398	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   47: astore 4
    //   49: aload 4
    //   51: invokevirtual 401	java/io/File:exists	()Z
    //   54: ifeq +98 -> 152
    //   57: new 599	java/io/BufferedReader
    //   60: dup
    //   61: new 46	java/io/FileReader
    //   64: dup
    //   65: aload 4
    //   67: invokespecial 49	java/io/FileReader:<init>	(Ljava/io/File;)V
    //   70: invokespecial 602	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   73: astore 4
    //   75: new 93	java/lang/StringBuilder
    //   78: dup
    //   79: invokespecial 94	java/lang/StringBuilder:<init>	()V
    //   82: astore 5
    //   84: aload 4
    //   86: invokevirtual 605	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   89: astore 7
    //   91: aload 7
    //   93: ifnull +79 -> 172
    //   96: aload 5
    ...
    //   119: astore 5
    //   121: aload 6
    //   123: invokestatic 180	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   126: ifne +192 -> 318
    //   129: new 9	com/baidu/android/bbalbs/common/util/b$b
    //   132: dup
    //   133: aconst_null
    //   134: invokespecial 444	com/baidu/android/bbalbs/common/util/b$b:<init>	(Lcom/baidu/android/bbalbs/common/util/c;)V
    //   137: astore_1
    //   138: aload_1
    //   139: aload 6
    //   141: putfield 465	com/baidu/android/bbalbs/common/util/b$b:a	Ljava/lang/String;
    //   144: aload_1
    //   145: aload 5
    //   147: putfield 467	com/baidu/android/bbalbs/common/util/b$b:b	Ljava/lang/String;
    //   150: aload_1
    //   151: areturn
    //   152: new 391	java/io/File
    //   155: dup
    //   156: invokestatic 484	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   159: ldc_w 495
    //   162: invokespecial 398	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   165: astore 4
    //   167: iconst_1
    //   168: istore_3
    //   169: goto -112 -> 57
    //   172: aload 4
    //   174: invokevirtual 608	java/io/BufferedReader:close	()V
    //   177: new 87	java/lang/String
    //   180: dup
    //   181: ldc_w 555
    //   184: ldc_w 555
    //   187: aload 5
    //   189: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   192: invokevirtual 254	java/lang/String:getBytes	()[B
    //   195: invokestatic 191	com/baidu/android/bbalbs/common/a/b:a	([B)[B
    //   198: invokestatic 610	com/baidu/android/bbalbs/common/a/a:b	(Ljava/lang/String;Ljava/lang/String;[B)[B
    //   201: invokespecial 196	java/lang/String:<init>	([B)V
    //   204: ldc_w 517
    //   207: invokevirtual 614	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   210: astore 5
    //   212: aload 5
    //   214: ifnull +146 -> 360
    //   217: aload 5
    ...
    //   231: iconst_0
    //   232: aaload
    //   233: invokevirtual 219	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   236: ifeq +54 -> 290
    //   239: aload 5
    //   241: iconst_1
    //   242: aaload
    ...
    //   262: aload 4
    //   264: aload_1
    //   265: invokestatic 497	com/baidu/android/bbalbs/common/util/b:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   268: aload_1
    //   269: astore 6
    //   271: aload 4
    //   273: astore 5
    ...
    //   295: astore 4
    //   297: aload_1
    //   298: invokestatic 180	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   301: ifeq +9 -> 310
    //   304: aload 5
    //   306: iconst_1
    //   307: aaload
  ...
  private b e()
  {
    ...
    if (((File)localObject).exists())
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        try
        {
          localObject = b.a(new String(a.b("30212102dicudiab", "30212102dicudiab", com.baidu.android.bbalbs.common.a.b.a(((String)localObject).getBytes()))));
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/com/baidu/android/bbalbs/common/util/b.class
