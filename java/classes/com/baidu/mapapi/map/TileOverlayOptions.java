...
public final class TileOverlayOptions
{
  ...
  public TileOverlayOptions setPositionFromBounds(LatLngBounds paramLatLngBounds)
  {
    ...
    if ((d1 > d3) && (d4 > d2))
    {
      c.putInt("rectr", (int)d4);
      c.putInt("rectb", (int)d3);
      c.putInt("rectl", (int)d2);
      c.putInt("rectt", (int)d1);
      return this;
    }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/com/baidu/mapapi/map/TileOverlayOptions.class
