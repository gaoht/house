  ...
  implements i, j
{
  ...
  {
    int i = 0;
    if (!paramObject.getClass().equals(org.json.a.b.class)) {
      return null;
    }
    Object localObject = a.a(paramType);
    paramObject = (org.json.a.b)paramObject;
    localObject = a((Class)localObject, paramType);
    if ((paramType instanceof ParameterizedType))
    {
      paramType = ((ParameterizedType)paramType).getActualTypeArguments()[0];
      while (i < ((org.json.a.b)paramObject).a.size())
      {
        ((Collection)localObject).add(e.a(((org.json.a.b)paramObject).a(i), paramType));
        i += 1;
      }
    }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/com/alipay/a/a/b.class
