...
public final class e
{
  ...
  public static final Object a(String paramString, Type paramType)
  {
    ...
    if ((paramString.startsWith("[")) && (paramString.endsWith("]"))) {
      return a(new org.json.a.b(paramString), paramType);
    }
    if ((paramString.startsWith("{")) && (paramString.endsWith("}"))) {
      return a(new org.json.a.c(paramString), paramType);
    }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/com/alipay/a/a/e.class
