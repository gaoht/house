...
public final class b
{
  ...
  public static String d()
  {
    ...
    //   13: dup
    //   14: ldc 121
    //   16: invokespecial 122	java/io/File:<init>	(Ljava/lang/String;)V
    //   19: invokespecial 125	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   22: astore_1
    //   23: new 127	java/io/InputStreamReader
    //   26: dup
    //   27: aload_1
    //   28: invokespecial 130	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   31: astore_3
    //   32: new 132	java/io/LineNumberReader
    //   35: dup
    //   36: aload_3
    //   37: invokespecial 135	java/io/LineNumberReader:<init>	(Ljava/io/Reader;)V
    //   40: astore 4
    //   42: iconst_1
    //   43: istore_0
    //   44: iload_0
    ...
    //   50: aload 4
    //   52: invokevirtual 138	java/io/LineNumberReader:readLine	()Ljava/lang/String;
    //   55: astore_2
    //   56: aload_2
    //   57: ifnull +245 -> 302
    //   60: aload_2
    //   61: ldc -116
    //   63: invokevirtual 144	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   66: iflt +49 -> 115
    //   69: aload_2
    //   70: aload_2
    //   71: ldc -110
    //   73: invokevirtual 144	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   76: iconst_1
    //   77: iadd
    //   78: aload_2
    //   79: invokevirtual 149	java/lang/String:length	()I
    //   82: invokevirtual 153	java/lang/String:substring	(II)Ljava/lang/String;
    //   85: invokevirtual 156	java/lang/String:trim	()Ljava/lang/String;
    //   88: astore_2
    //   89: aload 4
    //   91: invokevirtual 159	java/io/LineNumberReader:close	()V
    //   94: aload_3
    //   95: invokevirtual 160	java/io/InputStreamReader:close	()V
    //   98: aload_1
    //   99: invokevirtual 161	java/io/FileInputStream:close	()V
    //   102: aload_2
    //   103: astore_1
    //   104: aload_1
    //   105: astore_2
    ...
    //   137: ifnull +7 -> 144
    //   140: aload_1
    //   141: invokevirtual 159	java/io/LineNumberReader:close	()V
    //   144: aload_3
    //   145: ifnull +7 -> 152
    //   148: aload_3
    //   149: invokevirtual 160	java/io/InputStreamReader:close	()V
    //   152: aload_2
    //   153: ifnull +143 -> 296
    //   156: aload_2
    //   157: invokevirtual 161	java/io/FileInputStream:close	()V
    //   160: ldc -93
    //   162: astore_1
    //   163: goto -59 -> 104
    //   166: astore_1
    ...
    //   184: ifnull +8 -> 192
    //   187: aload 4
    //   189: invokevirtual 159	java/io/LineNumberReader:close	()V
    //   192: aload_3
    //   193: ifnull +7 -> 200
    //   196: aload_3
    //   197: invokevirtual 160	java/io/InputStreamReader:close	()V
    //   200: aload_1
    //   201: ifnull +7 -> 208
    //   204: aload_1
    //   205: invokevirtual 161	java/io/FileInputStream:close	()V
    //   208: aload_2
    //   209: athrow
    //   210: astore 4
    //   212: goto -118 -> 94
  ...
  public static String g()
  {
    ...
    //   67	1	0	localThrowable1	Throwable
    //   69	6	0	localObject1	Object
    //   89	1	0	localThrowable2	Throwable
    //   95	8	0	localObject2	Object
    //   116	1	0	localThrowable3	Throwable
    //   120	1	0	localThrowable4	Throwable
    //   123	1	0	localThrowable5	Throwable
    //   127	1	0	localThrowable6	Throwable
    //   131	1	0	localThrowable7	Throwable
    //   135	1	0	localThrowable8	Throwable
    //   139	1	0	localThrowable9	Throwable
    //   1	82	1	localObject3	Object
    //   93	29	1	str	String
    //   143	1	1	localObject4	Object
    //   149	1	1	localObject5	Object
    //   157	1	1	localThrowable10	Throwable
    //   159	1	1	localObject6	Object
    //   20	126	2	localBufferedReader	java.io.BufferedReader
    //   153	6	2	localThrowable11	Throwable
    // Exception table:
    //   from	to	target	type
    //   2	12	67	java/lang/Throwable
    //   82	86	89	java/lang/Throwable
    //   2	12	93	finally
    //   46	50	116	java/lang/Throwable
    //   50	54	120	java/lang/Throwable
    //   56	60	123	java/lang/Throwable
    //   60	64	127	java/lang/Throwable
    //   74	78	131	java/lang/Throwable
    //   102	106	135	java/lang/Throwable
    //   110	114	139	java/lang/Throwable
    //   12	21	143	finally
    //   21	32	149	finally
    //   36	42	149	finally
    //   12	21	153	java/lang/Throwable
    //   21	32	157	java/lang/Throwable
    //   36	42	157	java/lang/Throwable
  }
  ...
  public static String h()
  {
    ...
    //   15: astore 6
    //   17: new 224	java/io/BufferedReader
    //   20: dup
    //   21: aload 6
    //   23: sipush 8192
    //   26: invokespecial 292	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   29: astore 7
    //   31: aload 7
    //   33: invokevirtual 226	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   36: astore 5
    //   38: lload_3
    //   39: lstore_1
    //   40: aload 5
    ...
    //   53: iconst_1
    //   54: aaload
    //   55: invokestatic 302	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   58: istore_0
    //   59: iload_0
    //   60: i2l
    //   61: lstore_1
    //   62: aload 6
    //   64: invokevirtual 233	java/io/FileReader:close	()V
    //   67: aload 7
    //   69: invokevirtual 234	java/io/BufferedReader:close	()V
    //   72: lload_1
    //   73: invokestatic 83	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   76: areturn
    //   77: astore 6
    //   79: aconst_null
    //   80: astore 6
  ...
  public static String m(Context paramContext)
  {
    ...
    //   0: aload_0
    //   1: ldc 21
    //   3: invokestatic 24	com/alipay/c/a/a/b/b:a	(Landroid/content/Context;Ljava/lang/String;)Z
    //   6: ifeq +8 -> 14
    //   9: ldc 26
    //   11: astore_1
    //   12: aload_1
  ...
  public static String s()
  {
    ...
    //   135: dup
    //   136: aload 7
    //   138: invokespecial 523	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    ...
    //   154: ifnull +117 -> 271
    //   157: aload_3
    //   158: invokevirtual 526	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   161: aload 4
    //   163: aload 7
    //   165: invokeinterface 529 2 0
    //   170: checkcast 531	java/lang/CharSequence
    //   173: invokevirtual 535	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   176: istore_1
    //   177: iload_1
    //   178: ifeq -30 -> 148
    //   181: bipush 49
    ...
    //   184: aload 5
    //   186: iload_0
    //   187: invokevirtual 538	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    //   190: pop
    //   191: aload_2
    ...
    //   205: aload 5
    //   207: bipush 48
    //   209: invokevirtual 538	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    //   212: pop
    //   213: aload_2
    //   214: ifnull -114 -> 100
    //   217: aload_2
    ...
    //   229: aload 5
    //   231: bipush 48
    //   233: invokevirtual 538	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    //   236: pop
    //   237: aload_3
    //   238: ifnull +7 -> 245
    //   241: aload_3
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/com/alipay/c/a/a/b/b.class
