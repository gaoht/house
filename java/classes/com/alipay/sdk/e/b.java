...
public final class b
{
    ...
    throws Exception
  {
    try
    {
      DefaultHttpClient localDefaultHttpClient = this.b;
      if (!(localDefaultHttpClient instanceof HttpClient)) {
        return localDefaultHttpClient.execute(paramHttpUriRequest);
      }
      paramHttpUriRequest = ApacheHttpClientInstrumentation.execute((HttpClient)localDefaultHttpClient, paramHttpUriRequest);
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/com/alipay/sdk/e/b.class
