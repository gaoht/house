  ...
  implements WXMediaMessage.IMediaObject
{
  ...
  public boolean checkArgs()
  {
    ...
    {
      e.b().d("checkArgs fail, all arguments is null", new Object[0]);
      return false;
    }
    if ((this.extInfo != null) && (this.extInfo.length() > 2048))
    {
      e.b().d("checkArgs fail, extInfo is invalid", new Object[0]);
      return false;
    }
    if ((this.filePath != null) && (this.filePath.length() > 10240))
    {
      e.b().d("checkArgs fail, filePath is invalid", new Object[0]);
      return false;
    }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/cn/sharesdk/wechat/utils/WXAppExtendObject.class
