  ...
  implements WXMediaMessage.IMediaObject
{
  ...
  public boolean checkArgs()
  {
    ...
    {
      e.b().d("both musicUrl and musicLowBandUrl are null", new Object[0]);
      return false;
    }
    if ((this.musicUrl != null) && (this.musicUrl.length() > 10240))
    {
      e.b().d("checkArgs fail, musicUrl is too long", new Object[0]);
      return false;
    }
    if ((this.musicLowBandUrl != null) && (this.musicLowBandUrl.length() > 10240))
    {
      e.b().d("checkArgs fail, musicLowBandUrl is too long", new Object[0]);
      return false;
    }
    return true;
  }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/cn/sharesdk/wechat/utils/WXMusicObject.class
