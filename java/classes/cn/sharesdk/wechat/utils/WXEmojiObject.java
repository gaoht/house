  ...
  implements WXMediaMessage.IMediaObject
{
  ...
  public boolean checkArgs()
  {
    ...
    {
      e.b().d("MicroMsg.SDK.WXEmojiObject", new Object[] { "checkArgs fail, both arguments is null" });
      return false;
    }
    if ((this.emojiData != null) && (this.emojiData.length > 10485760))
    {
      e.b().d("MicroMsg.SDK.WXEmojiObject", new Object[] { "checkArgs fail, emojiData is too large" });
      return false;
    }
    if (this.emojiPath != null)
    {
      ...
      if (!localFile.exists())
      {
        e.b().d("MicroMsg.SDK.WXEmojiObject", new Object[] { "checkArgs fail, emojiPath not found" });
        return false;
      }
      if (localFile.length() > 10485760L)
      {
        e.b().d("MicroMsg.SDK.WXEmojiObject", new Object[] { "checkArgs fail, emojiSize is too large" });
        return false;
      }
    }
    return true;
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/cn/sharesdk/wechat/utils/WXEmojiObject.class
