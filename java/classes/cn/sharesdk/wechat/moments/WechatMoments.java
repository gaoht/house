  ...
  protected void doShare(Platform.ShareParams paramShareParams)
  {
    ...
    do
    {
      for (;;)
      {
        try
        {
          ((k)localObject).a(localj, paramShareParams, this.listener);
          return;
        }
        ...
        try
        {
          ((k)localObject).b(localj);
          if ((this.listener != null) && (((k)localObject).b()))
          {
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/cn/sharesdk/wechat/moments/WechatMoments.class
