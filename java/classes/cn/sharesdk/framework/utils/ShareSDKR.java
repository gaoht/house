...
public class ShareSDKR
{
  ...
  public static int getResId(Context paramContext, String paramString1, String paramString2)
  {
    ...
    e.b().w("failed to parse " + paramString1 + " resource \"" + paramString2 + "\"");
    return j;
  }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/cn/sharesdk/framework/utils/ShareSDKR.class
