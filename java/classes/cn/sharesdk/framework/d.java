  ...
  public void onReceivedSslError(WebView paramWebView, final SslErrorHandler paramSslErrorHandler, SslError paramSslError)
  {
    if ((paramWebView.getContext() instanceof Activity))
    {
      ...
      for (;;)
      {
        ...
        default: 
          ...
          ((AlertDialog.Builder)localObject).setPositiveButton(str1, new DialogInterface.OnClickListener()
          {
            ...
            public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
            {
              ...
              {
                e.b().w(paramAnonymousDialogInterface);
              }
            }
          });
        ...
        try
        {
          paramWebView = ((AlertDialog.Builder)localObject).create();
          if (!(paramWebView instanceof AlertDialog))
          {
            paramWebView.show();
            return;
            arrayOfString = new String[5];
          ...
          {
            VdsAgent.showDialog((AlertDialog)paramWebView);
            return;
          }
        }
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/cn/sharesdk/framework/d.class
