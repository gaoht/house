...
public class fa
{
  ...
  public static byte[] b(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    //   6: aload_0
    //   7: ifnonnull +13 -> 20
    //   10: new 204	java/lang/NullPointerException
    //   13: dup
    //   14: ldc -24
    //   16: invokespecial 209	java/lang/NullPointerException:<init>	(Ljava/lang/String;)V
    //   19: athrow
    //   20: iload_1
    //   21: ifge +30 -> 51
    //   24: new 213	java/lang/IllegalArgumentException
    //   27: dup
    ...
    //   40: iload_1
    //   41: invokevirtual 244	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   44: invokevirtual 247	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   47: invokespecial 226	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   50: athrow
    //   51: iload_2
    //   52: ifge +30 -> 82
    //   55: new 213	java/lang/IllegalArgumentException
    //   58: dup
    //   59: new 234	java/lang/StringBuilder
    //   62: dup
    //   63: invokespecial 235	java/lang/StringBuilder:<init>	()V
    //   66: ldc -7
    //   68: invokevirtual 241	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   71: iload_2
    //   72: invokevirtual 244	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   75: invokevirtual 247	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   78: invokespecial 226	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   81: athrow
    //   82: iload_1
    //   83: iload_2
    //   84: iadd
    ...
    //   86: arraylength
    //   87: if_icmple +42 -> 129
    //   90: new 213	java/lang/IllegalArgumentException
    //   93: dup
    //   94: ldc -5
    //   96: iconst_3
    ...
    //   108: iconst_1
    //   109: iload_2
    //   110: invokestatic 221	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   113: aastore
    //   114: dup
    //   115: iconst_2
    //   116: aload_0
    //   117: arraylength
    //   118: invokestatic 221	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   121: aastore
    //   122: invokestatic 225	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   125: invokespecial 226	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   128: athrow
    //   129: iload_3
    //   130: iconst_2
    //   131: iand
    //   132: ifeq +116 -> 248
    //   135: new 253	java/io/ByteArrayOutputStream
    //   138: dup
    //   139: invokespecial 254	java/io/ByteArrayOutputStream:<init>	()V
    //   142: astore 10
    //   144: new 256	cn/testin/analysis/fb
    //   147: dup
    //   148: aload 10
    //   150: iload_3
    //   151: iconst_1
    //   152: ior
    //   153: invokespecial 259	cn/testin/analysis/fb:<init>	(Ljava/io/OutputStream;I)V
    //   156: astore 12
    ...
    //   187: aload 12
    //   189: invokevirtual 272	cn/testin/analysis/fb:close	()V
    //   192: aload 10
    ...
    //   236: aload 11
    //   238: invokevirtual 272	cn/testin/analysis/fb:close	()V
    //   241: aload 13
    ...
    //   331: iload 4
    //   333: iload_3
    //   334: invokestatic 279	cn/testin/analysis/fa:a	([BII[BII)[B
    //   337: pop
    //   338: iload 5
    //   340: iconst_4
    //   341: iadd
    ...
    //   438: iload 4
    //   440: iload_3
    //   441: invokestatic 279	cn/testin/analysis/fa:a	([BII[BII)[B
    //   444: pop
    //   445: iload 4
    //   447: iconst_4
    //   448: iadd
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/cn/testin/analysis/fa.class
