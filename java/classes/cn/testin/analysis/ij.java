...
public class ij
{
  ...
  public ij(gt paramgt, gd paramgd)
  {
    this.a = paramgt;
  ...
  private float b(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    int[] arrayOfInt = a();
    int i = paramInt1;
    while ((i >= 0) && (localgt.a(paramInt2, i)))
    {
      arrayOfInt[2] += 1;
      i -= 1;
    }
    ...
    do
    {
      do
      {
        do
        {
          ...
          paramInt1 += 1;
          while ((paramInt1 < k) && (localgt.a(paramInt2, paramInt1)))
          {
            arrayOfInt[2] += 1;
            paramInt1 += 1;
          }
        } while (paramInt1 == k);
        while ((paramInt1 < k) && (!localgt.a(paramInt2, paramInt1)) && (arrayOfInt[3] < paramInt3))
        {
          arrayOfInt[3] += 1;
          paramInt1 += 1;
        }
      } while ((paramInt1 == k) || (arrayOfInt[3] >= paramInt3));
      while ((paramInt1 < k) && (localgt.a(paramInt2, paramInt1)) && (arrayOfInt[4] < paramInt3))
      {
        arrayOfInt[4] += 1;
        paramInt1 += 1;
      }
  ...
  private int b()
  {
    ...
    for (;;)
    {
      break;
      this.c = true;
      return (int)(Math.abs(((gc)localObject).a() - localii.a()) - Math.abs(((gc)localObject).b() - localii.b())) / 2;
      return 0;
    }
  }
  ...
  private float c(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    int[] arrayOfInt = a();
    int i = paramInt1;
    while ((i >= 0) && (localgt.a(i, paramInt2)))
    {
      arrayOfInt[2] += 1;
      i -= 1;
    }
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              return NaN.0F;
              while ((j >= 0) && (!localgt.a(j, paramInt2)) && (arrayOfInt[1] <= paramInt3))
              {
                arrayOfInt[1] += 1;
                j -= 1;
              }
            } while ((j < 0) || (arrayOfInt[1] > paramInt3));
            while ((j >= 0) && (localgt.a(j, paramInt2)) && (arrayOfInt[0] <= paramInt3))
            {
              arrayOfInt[0] += 1;
              j -= 1;
            }
          ...
          paramInt1 += 1;
          while ((paramInt1 < k) && (localgt.a(paramInt1, paramInt2)))
          {
            arrayOfInt[2] += 1;
            paramInt1 += 1;
          }
        } while (paramInt1 == k);
        while ((paramInt1 < k) && (!localgt.a(paramInt1, paramInt2)) && (arrayOfInt[3] < paramInt3))
        {
          arrayOfInt[3] += 1;
          paramInt1 += 1;
        }
      } while ((paramInt1 == k) || (arrayOfInt[3] >= paramInt3));
      while ((paramInt1 < k) && (localgt.a(paramInt1, paramInt2)) && (arrayOfInt[4] < paramInt3))
      {
        arrayOfInt[4] += 1;
        paramInt1 += 1;
      }
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        while (localIterator.hasNext()) {
          f2 += Math.abs(((ii)localIterator.next()).c() - f3);
        }
      } while (f2 > 0.05F * f1);
      return true;
    }
  ...
  private ii[] d()
  {
    ...
    if (i > 3)
    {
      ...
      while (localIterator.hasNext())
      {
        float f4 = ((ii)localIterator.next()).c();
        f2 += f4;
        f1 = f4 * f4 + f1;
      }
      f2 /= i;
      f1 = (float)Math.sqrt(f1 / i - f2 * f2);
      Collections.sort(this.b, new im(f2, null));
      f1 = Math.max(0.2F * f2, f1);
      int j;
      for (i = 0; (i < this.b.size()) && (this.b.size() > 3); i = j + 1)
      {
        j = i;
        if (Math.abs(((ii)this.b.get(i)).c() - f2) > f1)
        {
          this.b.remove(i);
          j = i - 1;
        }
    ...
    {
      localIterator = this.b.iterator();
      for (f1 = f3; localIterator.hasNext(); f1 += ((ii)localIterator.next()).c()) {}
      f1 /= this.b.size();
      Collections.sort(this.b, new il(f1, null));
      this.b.subList(3, this.b.size()).clear();
    }
    return new ii[] { (ii)this.b.get(0), (ii)this.b.get(1), (ii)this.b.get(2) };
  }
  
  final in a(Map<fs, ?> paramMap)
  {
    int j;
    boolean bool3;
    label37:
    ...
    int n;
    int m;
    if ((paramMap != null) && (paramMap.containsKey(fs.d)))
    {
      j = 1;
  ...
  protected final boolean a(int[] paramArrayOfInt, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        paramArrayOfInt = (ii)this.b.get(paramInt1);
      ...
      else
      {
        if (paramInt2 == 0)
        {
          paramArrayOfInt = new ii(f2, f1, f3);
...
/* Location:              /Users/gaoht/Downloads/zirom/classes-dex2jar.jar!/cn/testin/analysis/ij.class
